...
class StartAnalysisGlobalsTypedDict(TypedDict):
...
class StartAnalysisGlobals(BaseModel):
    accepts: Annotated[
...
class StartAnalysisRequestTypedDict(TypedDict):
    section_id: int
...
class StartAnalysisResponseTypedDict(TypedDict):
    content_type: str
