...
class UpdateRestrictedUserGlobalsTypedDict(TypedDict):
...
class UpdateRestrictedUserGlobals(BaseModel):
    accepts: Annotated[
...
class UpdateRestrictedUserRequestTypedDict(TypedDict):
    user_id: int
...
class UpdateRestrictedUserRequest(BaseModel):
    user_id: Annotated[
        int,
...
class UpdateRestrictedUserResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateRestrictedUserResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
