...
class StopDVRReloadGlobalsTypedDict(TypedDict):
...
class StopDVRReloadGlobals(BaseModel):
    accepts: Annotated[
...
class StopDVRReloadRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class StopDVRReloadRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class StopDVRReloadResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
