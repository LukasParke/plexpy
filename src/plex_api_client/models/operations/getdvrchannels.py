...
class GetDVRChannelsGlobalsTypedDict(TypedDict):
...
class GetDVRChannelsGlobals(BaseModel):
    accepts: Annotated[
...
class GetDVRChannelsRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class GetDVRChannelsRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class GetDVRChannelsResponseTypedDict(TypedDict):
    content_type: str
...
class GetDVRChannelsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
