...
from plex_api_client.models.components import (
    ...
    geoipresponse as components_geoipresponse,
)
...
class GetGeoIPGlobalsTypedDict(TypedDict):
...
class GetGeoIPGlobals(BaseModel):
    accepts: Annotated[
...
class GetGeoIPRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetGeoIPRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetGeoIPResponseTypedDict(TypedDict):
    content_type: str
    ...
    geo_ip_response: NotRequired[components_geoipresponse.GeoIPResponseTypedDict]
    r"""OK"""


class GetGeoIPResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    geo_ip_response: Optional[components_geoipresponse.GeoIPResponse] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["GeoIPResponse"])
        serialized = handler(self)
        m = {}
