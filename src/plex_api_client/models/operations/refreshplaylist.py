...
class RefreshPlaylistGlobalsTypedDict(TypedDict):
...
class RefreshPlaylistGlobals(BaseModel):
    accepts: Annotated[
...
class Action(str, Enum):
    r"""The action to perform for this item on this optimizer queue"""
...
class RefreshPlaylistRequestTypedDict(TypedDict):
    playlist_id: int
    r"""The ID of the playlist"""
    generator_id: int
    r"""The generator item ID to act on"""
    metadata_id: int
    r"""The metadata item ID to act on"""
    action: Action
    r"""The action to perform for this item on this optimizer queue"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class RefreshPlaylistRequest(BaseModel):
    ...
    action: Annotated[
        Action, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))
    ]
    r"""The action to perform for this item on this optimizer queue"""
...
class RefreshPlaylistResponseTypedDict(TypedDict):
    content_type: str
