...
class DeleteLiveTVSessionGlobalsTypedDict(TypedDict):
...
class DeleteLiveTVSessionGlobals(BaseModel):
    accepts: Annotated[
...
class DeleteLiveTVSessionRequestTypedDict(TypedDict):
    session_id: str
    r"""The session id"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class DeleteLiveTVSessionRequest(BaseModel):
...
class DeleteLiveTVSessionResponseTypedDict(TypedDict):
    content_type: str
...
class DeleteLiveTVSessionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
