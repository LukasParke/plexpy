...
from plex_api_client.models.components import (
    ...
    mediacontainerwithartwork as components_mediacontainerwithartwork,
)
...
class GetRandomArtworkGlobalsTypedDict(TypedDict):
...
class GetRandomArtworkGlobals(BaseModel):
    accepts: Annotated[
...
class GetRandomArtworkRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    sections: NotRequired[List[int]]
    r"""The sections for which to fetch artwork."""


class GetRandomArtworkRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetRandomArtworkResponseTypedDict(TypedDict):
    content_type: str
    ...
    media_container_with_artwork: NotRequired[
        components_mediacontainerwithartwork.MediaContainerWithArtworkTypedDict
    ]
    r"""OK"""


class GetRandomArtworkResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    media_container_with_artwork: Optional[
        components_mediacontainerwithartwork.MediaContainerWithArtwork
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["MediaContainerWithArtwork"])
        serialized = handler(self)
        m = {}
