...
class PlayerPlayGlobalsTypedDict(TypedDict):
...
class PlayerPlayGlobals(BaseModel):
    accepts: Annotated[
...
class PlayerPlayRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class PlayerPlayResponseTypedDict(TypedDict):
    content_type: str
...
class PlayerPlayResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
