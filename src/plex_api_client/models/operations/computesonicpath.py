...
class ComputeSonicPathGlobalsTypedDict(TypedDict):
...
class ComputeSonicPathGlobals(BaseModel):
    accepts: Annotated[
...
class ComputeSonicPathRequestTypedDict(TypedDict):
    id: int
...
class ComputeSonicPathRequest(BaseModel):
    id: Annotated[
...
class ComputeSonicPathResponseTypedDict(TypedDict):
    content_type: str
...
class ComputeSonicPathResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
