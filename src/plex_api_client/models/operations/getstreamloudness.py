...
class GetStreamLoudnessGlobalsTypedDict(TypedDict):
...
class GetStreamLoudnessGlobals(BaseModel):
    accepts: Annotated[
...
class GetStreamLoudnessRequestTypedDict(TypedDict):
    stream_id: int
...
class GetStreamLoudnessRequest(BaseModel):
    stream_id: Annotated[
        int,
...
class GetStreamLoudnessResponseTypedDict(TypedDict):
    content_type: str
...
class GetStreamLoudnessResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
