...
class BrowseFilesystemPathGlobalsTypedDict(TypedDict):
...
class BrowseFilesystemPathGlobals(BaseModel):
    accepts: Annotated[
...
class BrowseFilesystemPathRequestTypedDict(TypedDict):
    base64path: str
    r"""The base64path"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class BrowseFilesystemPathRequest(BaseModel):
    base64path: Annotated[
...
class BrowseFilesystemPathResponseTypedDict(TypedDict):
    content_type: str
...
class BrowseFilesystemPathResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
