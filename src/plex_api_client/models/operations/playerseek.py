...
class PlayerSeekGlobalsTypedDict(TypedDict):
...
class PlayerSeekGlobals(BaseModel):
    accepts: Annotated[
...
class PlayerSeekRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""Target offset in milliseconds"""
...
class PlayerSeekResponseTypedDict(TypedDict):
    content_type: str
...
class PlayerSeekResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
