...
class GetItemDecisionGlobalsTypedDict(TypedDict):
...
class GetItemDecisionGlobals(BaseModel):
    accepts: Annotated[
...
class GetItemDecisionRequestTypedDict(TypedDict):
    queue_id: int
    r"""The queue id"""
    item_id: int
    r"""The item ids"""
...
class GetItemDecisionRequest(BaseModel):
    queue_id: Annotated[
        int,
...
class GetItemDecisionResponseTypedDict(TypedDict):
    content_type: str
...
class GetItemDecisionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
