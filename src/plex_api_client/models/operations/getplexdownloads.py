...
from plex_api_client.models.components import (
    ...
    plexdownloadsresponse as components_plexdownloadsresponse,
)
...
class GetPlexDownloadsGlobalsTypedDict(TypedDict):
...
class GetPlexDownloadsGlobals(BaseModel):
    accepts: Annotated[
...
class GetPlexDownloadsRequestTypedDict(TypedDict):
    channel: str
...
class GetPlexDownloadsRequest(BaseModel):
    channel: Annotated[
...
class GetPlexDownloadsResponseTypedDict(TypedDict):
    content_type: str
    ...
    plex_downloads_response: NotRequired[
        components_plexdownloadsresponse.PlexDownloadsResponseTypedDict
    ]
    r"""OK"""


class GetPlexDownloadsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    plex_downloads_response: Optional[
        components_plexdownloadsresponse.PlexDownloadsResponse
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["PlexDownloadsResponse"])
        serialized = handler(self)
        m = {}
