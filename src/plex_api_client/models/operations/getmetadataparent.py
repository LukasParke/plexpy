...
class GetMetadataParentGlobalsTypedDict(TypedDict):
...
class GetMetadataParentGlobals(BaseModel):
    accepts: Annotated[
...
class GetMetadataParentRequestTypedDict(TypedDict):
    id: int
...
class GetMetadataParentRequest(BaseModel):
    id: Annotated[
...
class GetMetadataParentResponseTypedDict(TypedDict):
    content_type: str
...
class GetMetadataParentResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
