...
class GetHLSSegmentGlobalsTypedDict(TypedDict):
...
class GetHLSSegmentGlobals(BaseModel):
    accepts: Annotated[
...
class GetHLSSegmentRequestTypedDict(TypedDict):
    transcode_type: str
...
class GetHLSSegmentRequest(BaseModel):
...
class GetHLSSegmentResponseTypedDict(TypedDict):
    content_type: str
...
class GetHLSSegmentResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
