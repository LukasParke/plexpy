...
class AnalyzeMetadataGlobalsTypedDict(TypedDict):
...
class AnalyzeMetadataGlobals(BaseModel):
    accepts: Annotated[
...
class AnalyzeMetadataRequestTypedDict(TypedDict):
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    thumb_offset: NotRequired[float]
    r"""Set the offset to be used for thumbnails"""
    art_offset: NotRequired[float]
    r"""Set the offset to be used for artwork"""
...
class AnalyzeMetadataRequest(BaseModel):
    ...
    thumb_offset: Annotated[
        Optional[float],
        pydantic.Field(alias="thumbOffset"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Set the offset to be used for thumbnails"""

    art_offset: Annotated[
        Optional[float],
        pydantic.Field(alias="artOffset"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Set the offset to be used for artwork"""
...
class AnalyzeMetadataResponseTypedDict(TypedDict):
    content_type: str
