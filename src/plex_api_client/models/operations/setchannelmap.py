...
class SetChannelmapGlobalsTypedDict(TypedDict):
...
class ChannelMappingTypedDict(TypedDict):
    r"""The mapping of changes, passed as a map of device channel to lineup VCN."""
...
class ChannelMappingByKeyTypedDict(TypedDict):
    r"""The mapping of changes, passed as a map of device channel to lineup key."""


class ChannelMappingByKey(BaseModel):
    r"""The mapping of changes, passed as a map of device channel to lineup key."""


class SetChannelmapRequestTypedDict(TypedDict):
    device_id: int
    ...
    r"""The mapping of changes, passed as a map of device channel to lineup VCN."""
    channel_mapping_by_key: NotRequired[ChannelMappingByKeyTypedDict]
    r"""The mapping of changes, passed as a map of device channel to lineup key."""
    channels_enabled: NotRequired[List[str]]
    r"""The channels which are enabled."""


class SetChannelmapRequest(BaseModel):
    device_id: Annotated[
        int,
    ...
    channel_mapping: Annotated[
        Optional[ChannelMapping],
        pydantic.Field(alias="channelMapping"),
        FieldMetadata(query=QueryParamMetadata(style="deepObject", explode=True)),
    ] = None
    r"""The mapping of changes, passed as a map of device channel to lineup VCN."""

    channel_mapping_by_key: Annotated[
        Optional[ChannelMappingByKey],
        pydantic.Field(alias="channelMappingByKey"),
        FieldMetadata(query=QueryParamMetadata(style="deepObject", explode=True)),
    ] = None
    r"""The mapping of changes, passed as a map of device channel to lineup key."""

    channels_enabled: Annotated[
        Optional[List[str]],
        pydantic.Field(alias="channelsEnabled"),
...
class SetChannelmapResponseTypedDict(TypedDict):
    content_type: str
...
class SetChannelmapResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
