...
class GetSectionImageGlobalsTypedDict(TypedDict):
...
class GetSectionImageGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionImageRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionImageRequest(BaseModel):
...
class GetSectionImageResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionImageResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
