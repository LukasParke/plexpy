...
class GetSubtitlesGlobalsTypedDict(TypedDict):
...
class GetSubtitlesGlobals(BaseModel):
    accepts: Annotated[
...
class GetSubtitlesRequestTypedDict(TypedDict):
    ids: str
    ...
    r"""The unique identifier of the mediaitem"""
    url: NotRequired[str]
    ...
    r"""The hearingImpaired"""


class GetSubtitlesRequest(BaseModel):
    ids: Annotated[
...
class GetSubtitlesResponseTypedDict(TypedDict):
    content_type: str
