...
class GetMetadataAgentDetailsGlobalsTypedDict(TypedDict):
...
class GetMetadataAgentDetailsGlobals(BaseModel):
    accepts: Annotated[
...
class GetMetadataAgentDetailsRequestTypedDict(TypedDict):
    agent_id: str
    r"""The unique identifier of the metadata agent"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetMetadataAgentDetailsRequest(BaseModel):
    agent_id: Annotated[
        str,
...
class GetMetadataAgentDetailsResponseTypedDict(TypedDict):
    content_type: str
...
class GetMetadataAgentDetailsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
