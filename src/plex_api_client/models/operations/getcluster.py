...
class GetClusterGlobalsTypedDict(TypedDict):
...
class GetClusterGlobals(BaseModel):
    accepts: Annotated[
...
class GetClusterRequestTypedDict(TypedDict):
    section_id: int
...
class GetClusterResponseTypedDict(TypedDict):
    content_type: str
