...
class GetSectionPreferencesGlobalsTypedDict(TypedDict):
...
class GetSectionPreferencesGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionPreferencesRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionPreferencesResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionPreferencesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
