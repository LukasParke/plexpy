...
class GetDASHSegmentGlobalsTypedDict(TypedDict):
...
class GetDASHSegmentGlobals(BaseModel):
    accepts: Annotated[
...
class GetDASHSegmentRequestTypedDict(TypedDict):
    transcode_type: str
    r"""The type of transcoding (e.g., video, audio)"""
    session_id: str
    r"""The unique identifier of the session"""
    segment_id: str
    r"""The unique identifier of the media segment"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetDASHSegmentRequest(BaseModel):
    ...
    segment_id: Annotated[
        str,
        pydantic.Field(alias="segmentId"),
        FieldMetadata(path=PathParamMetadata(style="simple", explode=False)),
    ]
    r"""The unique identifier of the media segment"""
...
class GetDASHSegmentResponseTypedDict(TypedDict):
    content_type: str
...
class GetDASHSegmentResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
