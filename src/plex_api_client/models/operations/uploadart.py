...
class UploadArtGlobalsTypedDict(TypedDict):
...
class UploadArtGlobals(BaseModel):
    accepts: Annotated[
...
class UploadArtRequestBodyTypedDict(TypedDict):
    file: NotRequired[FileTypedDict]


class UploadArtRequestBody(BaseModel):
    file: Annotated[
...
class UploadArtRequestTypedDict(TypedDict):
    id: int
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    request_body: NotRequired[UploadArtRequestBodyTypedDict]


class UploadArtRequest(BaseModel):
    id: Annotated[
...
class UploadArtResponseTypedDict(TypedDict):
    content_type: str
...
class UploadArtResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
