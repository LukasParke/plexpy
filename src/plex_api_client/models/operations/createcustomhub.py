...
class CreateCustomHubGlobalsTypedDict(TypedDict):
...
class CreateCustomHubGlobals(BaseModel):
    accepts: Annotated[
...
class CreateCustomHubRequestTypedDict(TypedDict):
    section_id: int
    r"""The section ID for the hubs to reorder"""
    metadata_item_id: int
    r"""The metadata item on which to base this hub.  This must currently be a collection"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    promoted_to_recommended: NotRequired[components_boolint.BoolInt]
    r"""Whether this hub should be displayed in recommended"""
    promoted_to_own_home: NotRequired[components_boolint.BoolInt]
    r"""Whether this hub should be displayed in admin's home"""
    promoted_to_shared_home: NotRequired[components_boolint.BoolInt]
    r"""Whether this hub should be displayed in shared user's home"""


class CreateCustomHubRequest(BaseModel):
...
class CreateCustomHubResponseTypedDict(TypedDict):
    content_type: str
...
class CreateCustomHubResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
