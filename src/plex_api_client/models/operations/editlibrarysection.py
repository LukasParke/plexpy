...
class EditLibrarySectionGlobalsTypedDict(TypedDict):
...
class EditLibrarySectionGlobals(BaseModel):
    accepts: Annotated[
...
class EditLibrarySectionRequestTypedDict(TypedDict):
    section_id: int
...
class EditLibrarySectionRequest(BaseModel):
...
class EditLibrarySectionResponseTypedDict(TypedDict):
    content_type: str
...
class EditLibrarySectionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
