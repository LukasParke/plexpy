...
class GetStreamLevelsGlobalsTypedDict(TypedDict):
...
class GetStreamLevelsGlobals(BaseModel):
    accepts: Annotated[
...
class GetStreamLevelsRequestTypedDict(TypedDict):
    stream_id: int
    r"""The id of the stream"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    subsample: NotRequired[int]
    r"""Subsample result down to return only the provided number of samples"""


class GetStreamLevelsRequest(BaseModel):
    stream_id: Annotated[
        int,
...
class GetStreamLevelsLevelTypedDict(TypedDict):
    v: NotRequired[float]
    r"""The level in db."""


class GetStreamLevelsLevel(BaseModel):
    v: Optional[float] = None
    r"""The level in db."""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["v"])
        serialized = handler(self)
        m = {}
...
class GetStreamLevelsMediaContainerTypedDict(TypedDict):
    ...
    """
    level: NotRequired[List[GetStreamLevelsLevelTypedDict]]
    total_samples: NotRequired[str]
    r"""The total number of samples (as a string)"""


class GetStreamLevelsMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
    ...
    level: Annotated[
        Optional[List[GetStreamLevelsLevel]], pydantic.Field(alias="Level")
    ] = None

    total_samples: Annotated[Optional[str], pydantic.Field(alias="totalSamples")] = None
    r"""The total number of samples (as a string)"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(
            ["identifier", "offset", "size", "totalSize", "Level", "totalSamples"]
        )
        serialized = handler(self)
        m = {}
...
class GetStreamLevelsResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[GetStreamLevelsMediaContainerTypedDict]


class GetStreamLevelsResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[GetStreamLevelsMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None
...
class GetStreamLevelsResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[GetStreamLevelsResponseBodyTypedDict]
    r"""OK"""


class GetStreamLevelsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    object: Optional[GetStreamLevelsResponseBody] = None
    r"""OK"""
...
try:
    GetStreamLevelsMediaContainer.model_rebuild()
except NameError:
    pass
try:
    GetStreamLevelsResponseBody.model_rebuild()
except NameError:
    pass
