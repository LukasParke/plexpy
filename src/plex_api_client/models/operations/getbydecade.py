...
class GetByDecadeGlobalsTypedDict(TypedDict):
...
class GetByDecadeGlobals(BaseModel):
    accepts: Annotated[
...
class GetByDecadeRequestTypedDict(TypedDict):
    section_id: int
...
class GetByDecadeRequest(BaseModel):
...
class GetByDecadeResponseTypedDict(TypedDict):
    content_type: str
...
class GetByDecadeResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
