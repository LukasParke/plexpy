...
class GetDownloadQueueMediaGlobalsTypedDict(TypedDict):
...
class GetDownloadQueueMediaGlobals(BaseModel):
    accepts: Annotated[
...
class GetDownloadQueueMediaRequest(BaseModel):
    queue_id: Annotated[
        int,
...
class GetDownloadQueueMediaResponseTypedDict(TypedDict):
    content_type: str
    ...
    r"""The raw media file"""


class GetDownloadQueueMediaResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
