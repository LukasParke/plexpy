...
class GetByResolutionGlobalsTypedDict(TypedDict):
...
class GetByResolutionGlobals(BaseModel):
    accepts: Annotated[
...
class GetByResolutionRequestTypedDict(TypedDict):
    section_id: int
...
class GetByResolutionRequest(BaseModel):
...
class GetByResolutionResponseTypedDict(TypedDict):
    content_type: str
...
class GetByResolutionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
