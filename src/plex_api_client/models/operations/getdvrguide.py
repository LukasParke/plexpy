...
class GetDVRGuideGlobalsTypedDict(TypedDict):
...
class GetDVRGuideGlobals(BaseModel):
    accepts: Annotated[
...
class GetDVRGuideRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class GetDVRGuideRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class GetDVRGuideResponseTypedDict(TypedDict):
    content_type: str
...
class GetDVRGuideResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
