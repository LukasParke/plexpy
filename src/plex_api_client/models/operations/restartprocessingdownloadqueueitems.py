...
class RestartProcessingDownloadQueueItemsGlobalsTypedDict(TypedDict):
...
class RestartProcessingDownloadQueueItemsGlobals(BaseModel):
    accepts: Annotated[
...
class RestartProcessingDownloadQueueItemsRequestTypedDict(TypedDict):
    queue_id: int
    r"""The queue id"""
    item_id: List[int]
    r"""The item ids"""
...
class RestartProcessingDownloadQueueItemsRequest(BaseModel):
    queue_id: Annotated[
        int,
...
class RestartProcessingDownloadQueueItemsResponseTypedDict(TypedDict):
    content_type: str
...
class RestartProcessingDownloadQueueItemsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
