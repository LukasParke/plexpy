...
class PlayerSetStreamsGlobalsTypedDict(TypedDict):
...
class PlayerSetStreamsGlobals(BaseModel):
    accepts: Annotated[
...
class PlayerSetStreamsRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    x_plex_target_client_identifier: NotRequired[str]
    r"""The client identifier of the target device to control. If omitted, the command is sent to the default/active client."""
    audio_stream_id: NotRequired[int]
    r"""The unique identifier of the audiostream"""
    subtitle_stream_id: NotRequired[int]
    r"""The unique identifier of the subtitlestream"""
    video_stream_id: NotRequired[int]
    r"""The unique identifier of the videostream"""


class PlayerSetStreamsRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
    ...
    x_plex_target_client_identifier: Annotated[
        Optional[str],
        pydantic.Field(alias="X-Plex-Target-Client-Identifier"),
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = None
    r"""The client identifier of the target device to control. If omitted, the command is sent to the default/active client."""
    ...
    audio_stream_id: Annotated[
        Optional[int],
        pydantic.Field(alias="audioStreamID"),
    ...
    subtitle_stream_id: Annotated[
        Optional[int],
        pydantic.Field(alias="subtitleStreamID"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""The unique identifier of the subtitlestream"""
    ...
    video_stream_id: Annotated[
        Optional[int],
        pydantic.Field(alias="videoStreamID"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""The unique identifier of the videostream"""
...
class PlayerSetStreamsResponseTypedDict(TypedDict):
    content_type: str
...
class PlayerSetStreamsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
