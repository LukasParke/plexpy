...
class GetAvailableSortsGlobalsTypedDict(TypedDict):
...
class GetAvailableSortsGlobals(BaseModel):
    accepts: Annotated[
...
class GetAvailableSortsRequestTypedDict(TypedDict):
    section_id: int
...
class GetAvailableSortsRequest(BaseModel):
...
class GetAvailableSortsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
