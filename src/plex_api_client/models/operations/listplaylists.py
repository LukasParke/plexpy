...
class ListPlaylistsGlobalsTypedDict(TypedDict):
...
class ListPlaylistsGlobals(BaseModel):
    accepts: Annotated[
...
class ListPlaylistsRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class ListPlaylistsResponseTypedDict(TypedDict):
    content_type: str
