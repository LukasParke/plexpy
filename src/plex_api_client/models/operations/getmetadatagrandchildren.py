...
class GetMetadataGrandchildrenGlobalsTypedDict(TypedDict):
...
class GetMetadataGrandchildrenGlobals(BaseModel):
    accepts: Annotated[
...
class GetMetadataGrandchildrenRequestTypedDict(TypedDict):
    id: int
...
class GetMetadataGrandchildrenRequest(BaseModel):
    id: Annotated[
...
class GetMetadataGrandchildrenResponseTypedDict(TypedDict):
    content_type: str
...
class GetMetadataGrandchildrenResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
