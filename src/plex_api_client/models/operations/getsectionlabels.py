...
class GetSectionLabelsGlobalsTypedDict(TypedDict):
...
class GetSectionLabelsGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionLabelsRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionLabelsRequest(BaseModel):
...
class GetSectionLabelsResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionLabelsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
