...
class EmptyTrashPutGlobalsTypedDict(TypedDict):
...
class EmptyTrashPutGlobals(BaseModel):
    accepts: Annotated[
...
class EmptyTrashPutRequestTypedDict(TypedDict):
    section_id: int
...
class EmptyTrashPutRequest(BaseModel):
...
class EmptyTrashPutResponseTypedDict(TypedDict):
    content_type: str
...
class EmptyTrashPutResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
