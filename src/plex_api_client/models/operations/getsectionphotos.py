...
class GetSectionPhotosGlobalsTypedDict(TypedDict):
...
class GetSectionPhotosGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionPhotosRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionPhotosRequest(BaseModel):
...
class GetSectionPhotosResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionPhotosResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
