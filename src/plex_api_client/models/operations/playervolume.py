...
class PlayerVolumeGlobalsTypedDict(TypedDict):
...
class PlayerVolumeGlobals(BaseModel):
    accepts: Annotated[
...
class PlayerVolumeRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class PlayerVolumeResponseTypedDict(TypedDict):
    content_type: str
...
class PlayerVolumeResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
