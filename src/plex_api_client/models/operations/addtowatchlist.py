...
class AddToWatchlistGlobalsTypedDict(TypedDict):
...
class AddToWatchlistGlobals(BaseModel):
    accepts: Annotated[
...
class AddToWatchlistRequestTypedDict(TypedDict):
    uri: str
...
class AddToWatchlistResponseTypedDict(TypedDict):
    content_type: str
