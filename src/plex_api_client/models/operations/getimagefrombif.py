...
class GetImageFromBifGlobalsTypedDict(TypedDict):
...
class GetImageFromBifGlobals(BaseModel):
    accepts: Annotated[
...
class PathParamIndex(str, Enum):
    r"""The type of index to grab."""

    SD = "sd"


class GetImageFromBifRequestTypedDict(TypedDict):
    part_id: int
    r"""The part id who's index is to be fetched"""
    index: PathParamIndex
    r"""The type of index to grab."""
    offset: int
    r"""The offset to seek in ms."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetImageFromBifRequest(BaseModel):
    part_id: Annotated[
        int,
...
class GetImageFromBifResponseTypedDict(TypedDict):
    content_type: str
...
class GetImageFromBifResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
