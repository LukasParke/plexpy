...
class GetSectionPlaylistsGlobalsTypedDict(TypedDict):
...
class GetSectionPlaylistsGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionPlaylistsRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionPlaylistsRequest(BaseModel):
...
class GetSectionPlaylistsResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionPlaylistsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
