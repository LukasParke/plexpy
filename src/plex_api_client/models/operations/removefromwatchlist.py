...
class RemoveFromWatchlistGlobalsTypedDict(TypedDict):
...
class RemoveFromWatchlistGlobals(BaseModel):
    accepts: Annotated[
...
class RemoveFromWatchlistRequestTypedDict(TypedDict):
    uri: str
    r"""The URI of the item to add or remove"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class RemoveFromWatchlistResponseTypedDict(TypedDict):
    content_type: str
