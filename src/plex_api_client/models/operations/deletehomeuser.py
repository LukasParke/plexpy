...
class DeleteHomeUserGlobalsTypedDict(TypedDict):
...
class DeleteHomeUserGlobals(BaseModel):
    accepts: Annotated[
...
class DeleteHomeUserRequestTypedDict(TypedDict):
    user_id: int
...
class DeleteHomeUserRequest(BaseModel):
    user_id: Annotated[
        int,
...
class DeleteHomeUserResponseTypedDict(TypedDict):
    content_type: str
...
class DeleteHomeUserResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
