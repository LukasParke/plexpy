...
class UpdateShareGlobalsTypedDict(TypedDict):
...
class UpdateShareGlobals(BaseModel):
    accepts: Annotated[
...
class UpdateShareRequestTypedDict(TypedDict):
    user_id: int
...
class UpdateShareResponseTypedDict(TypedDict):
    content_type: str
