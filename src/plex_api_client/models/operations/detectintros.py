...
class DetectIntrosGlobalsTypedDict(TypedDict):
...
class DetectIntrosGlobals(BaseModel):
    accepts: Annotated[
...
class DetectIntrosRequestTypedDict(TypedDict):
    ids: str
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    ...
    r"""The threshold for determining if content is an intro or not"""


class DetectIntrosRequest(BaseModel):
    ids: Annotated[
...
class DetectIntrosResponseTypedDict(TypedDict):
    content_type: str
...
class DetectIntrosResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
