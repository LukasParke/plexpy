...
class MoveSectionGlobalsTypedDict(TypedDict):
...
class MoveSectionGlobals(BaseModel):
    accepts: Annotated[
...
class MoveSectionRequestTypedDict(TypedDict):
    section_id: int
...
class MoveSectionResponseTypedDict(TypedDict):
    content_type: str
