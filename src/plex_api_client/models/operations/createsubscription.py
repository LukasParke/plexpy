...
from plex_api_client.models.components import (
    ...
    mediasubscription as components_mediasubscription,
)
...
class HintsTypedDict(TypedDict):
...
class CreateSubscriptionQueryParamPrefsTypedDict(TypedDict):
    r"""Subscription preferences."""


class CreateSubscriptionQueryParamPrefs(BaseModel):
    r"""Subscription preferences."""
...
class CreateSubscriptionRequestTypedDict(TypedDict):
    ...
    r"""Hints describing what we're looking for.  Note: The hint `ratingKey` is required for downloading from a PMS remote."""
    prefs: NotRequired[CreateSubscriptionQueryParamPrefsTypedDict]
    r"""Subscription preferences."""
...
class CreateSubscriptionRequest(BaseModel):
    ...
    target_library_section_id: Annotated[
        Optional[int],
        pydantic.Field(alias="targetLibrarySectionID"),
    ...
    target_section_location_id: Annotated[
        Optional[int],
        pydantic.Field(alias="targetSectionLocationID"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""The section location into which to grab."""
    ...
    prefs: Annotated[
        Optional[CreateSubscriptionQueryParamPrefs],
        FieldMetadata(query=QueryParamMetadata(style="deepObject", explode=True)),
    ] = None
    r"""Subscription preferences."""
...
class CreateSubscriptionMediaContainerTypedDict(TypedDict):
...
class CreateSubscriptionMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
    ...
    media_subscription: Annotated[
        ...
        pydantic.Field(alias="MediaSubscription"),
    ] = None
...
class CreateSubscriptionResponseBodyTypedDict(TypedDict):
    ...
    media_container: NotRequired[CreateSubscriptionMediaContainerTypedDict]
...
class CreateSubscriptionResponseBody(BaseModel):
    ...
    media_container: Annotated[
        Optional[CreateSubscriptionMediaContainer],
...
class CreateSubscriptionResponseTypedDict(TypedDict):
    ...
    object: NotRequired[CreateSubscriptionResponseBodyTypedDict]
    r"""OK"""
...
class CreateSubscriptionResponse(BaseModel):
    ...
    object: Optional[CreateSubscriptionResponseBody] = None
    r"""OK"""
...
try:
    CreateSubscriptionMediaContainer.model_rebuild()
except NameError:
    pass
try:
    CreateSubscriptionResponseBody.model_rebuild()
except NameError:
    pass
