...
class MoveCollectionItemGlobalsTypedDict(TypedDict):
...
class MoveCollectionItemGlobals(BaseModel):
    accepts: Annotated[
...
class MoveCollectionItemRequestTypedDict(TypedDict):
    ...
    r"""The item to move this item after.  If not provided, this item will be moved to the beginning"""
