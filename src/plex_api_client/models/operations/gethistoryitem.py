...
from plex_api_client.models.components import (
    ...
    historyall_get_responses_200 as components_historyall_get_responses_200,
)
...
class GetHistoryItemGlobalsTypedDict(TypedDict):
...
class GetHistoryItemGlobals(BaseModel):
    accepts: Annotated[
...
class GetHistoryItemRequestTypedDict(TypedDict):
    history_id: int
...
class GetHistoryItemRequest(BaseModel):
...
class GetHistoryItemResponseTypedDict(TypedDict):
    content_type: str
...
class GetHistoryItemResponse(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["historyAll-get-responses-200"])
        serialized = handler(self)
        m = {}
