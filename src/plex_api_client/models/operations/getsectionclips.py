...
class GetSectionClipsGlobalsTypedDict(TypedDict):
...
class GetSectionClipsGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionClipsRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionClipsRequest(BaseModel):
...
class GetSectionClipsResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionClipsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
