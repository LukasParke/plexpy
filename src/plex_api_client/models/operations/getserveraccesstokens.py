...
from plex_api_client.models.components import (
    ...
    serveraccesstokensresponse as components_serveraccesstokensresponse,
)
...
class GetServerAccessTokensGlobalsTypedDict(TypedDict):
...
class GetServerAccessTokensGlobals(BaseModel):
    accepts: Annotated[
...
class GetServerAccessTokensRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetServerAccessTokensRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetServerAccessTokensResponseTypedDict(TypedDict):
    content_type: str
    ...
    server_access_tokens_response: NotRequired[
        components_serveraccesstokensresponse.ServerAccessTokensResponseTypedDict
    ]
    r"""OK"""


class GetServerAccessTokensResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    server_access_tokens_response: Optional[
        components_serveraccesstokensresponse.ServerAccessTokensResponse
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["ServerAccessTokensResponse"])
        serialized = handler(self)
        m = {}
