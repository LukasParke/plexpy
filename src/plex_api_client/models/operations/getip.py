...
from plex_api_client.models.components import (
    ...
    ipresponse as components_ipresponse,
)
...
class GetIPGlobalsTypedDict(TypedDict):
...
class GetIPResponseTypedDict(TypedDict):
    content_type: str
    ...
    ip_response: NotRequired[components_ipresponse.IPResponseTypedDict]
    r"""OK"""


class GetIPResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    ip_response: Optional[components_ipresponse.IPResponse] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["IPResponse"])
        serialized = handler(self)
        m = {}
