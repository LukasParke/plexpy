...
class GetCountriesLineupsGlobalsTypedDict(TypedDict):
...
class GetCountriesLineupsGlobals(BaseModel):
    accepts: Annotated[
...
class GetCountriesLineupsRequestTypedDict(TypedDict):
    country: str
    ...
    r"""The postal code for the lineups to fetch"""


class GetCountriesLineupsRequest(BaseModel):
    country: Annotated[
    ...
    postal_code: Annotated[
        Optional[str],
        pydantic.Field(alias="postalCode"),
...
class GetCountriesLineupsResponseTypedDict(TypedDict):
    content_type: str
...
class GetCountriesLineupsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
