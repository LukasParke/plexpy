...
class MergeItemsGlobalsTypedDict(TypedDict):
...
class MergeItemsGlobals(BaseModel):
    accepts: Annotated[
...
class MergeItemsResponseTypedDict(TypedDict):
    content_type: str
