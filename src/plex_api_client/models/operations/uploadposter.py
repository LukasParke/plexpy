...
class UploadPosterGlobalsTypedDict(TypedDict):
...
class UploadPosterGlobals(BaseModel):
    accepts: Annotated[
...
class UploadPosterFileTypedDict(TypedDict):
    file_name: str
    content: Union[bytes, IO[bytes], io.IOBase]
    content_type: NotRequired[str]


class UploadPosterFile(BaseModel):
    file_name: Annotated[
...
class UploadPosterRequestBodyTypedDict(TypedDict):
    file: NotRequired[UploadPosterFileTypedDict]


class UploadPosterRequestBody(BaseModel):
    file: Annotated[
        Optional[UploadPosterFile],
...
class UploadPosterRequestTypedDict(TypedDict):
    id: int
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    request_body: NotRequired[UploadPosterRequestBodyTypedDict]


class UploadPosterRequest(BaseModel):
    id: Annotated[
    ...
    request_body: Annotated[
        Optional[UploadPosterRequestBody],
...
class UploadPosterResponseTypedDict(TypedDict):
    content_type: str
...
class UploadPosterResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
