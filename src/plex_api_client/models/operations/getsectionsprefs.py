...
class GetSectionsPrefsGlobalsTypedDict(TypedDict):
...
class GetSectionsPrefsGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionsPrefsResponseTypedDict(TypedDict):
    content_type: str
