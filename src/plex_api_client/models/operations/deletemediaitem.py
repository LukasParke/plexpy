...
class DeleteMediaItemGlobalsTypedDict(TypedDict):
...
class DeleteMediaItemGlobals(BaseModel):
    accepts: Annotated[
...
class DeleteMediaItemRequest(BaseModel):
    ids: Annotated[
...
class DeleteMediaItemResponseTypedDict(TypedDict):
    content_type: str
...
class DeleteMediaItemResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
