...
class UpdateDVRSettingsGlobalsTypedDict(TypedDict):
...
class UpdateDVRSettingsGlobals(BaseModel):
    accepts: Annotated[
...
class UpdateDVRSettingsRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class UpdateDVRSettingsRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class UpdateDVRSettingsResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateDVRSettingsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
