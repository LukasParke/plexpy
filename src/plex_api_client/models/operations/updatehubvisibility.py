...
class UpdateHubVisibilityGlobalsTypedDict(TypedDict):
...
class UpdateHubVisibilityRequestTypedDict(TypedDict):
    section_id: int
    r"""The section ID for the hubs to change"""
    identifier: str
    r"""The identifier of the hub to change"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class UpdateHubVisibilityRequest(BaseModel):
...
class UpdateHubVisibilityResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateHubVisibilityResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
