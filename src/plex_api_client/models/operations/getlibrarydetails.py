...
AllowSyncTypedDict = TypeAliasType("AllowSyncTypedDict", Union[bool, Two])


AllowSync = TypeAliasType("AllowSync", Union[bool, Two])
...
try:
    GetLibraryDetailsMediaContainer.model_rebuild()
except NameError:
    pass
try:
    GetLibraryDetailsResponseBody.model_rebuild()
except NameError:
    pass
