...
class UpdateItemArtworkGlobalsTypedDict(TypedDict):
...
class UpdateItemArtworkGlobals(BaseModel):
    accepts: Annotated[
...
class UpdateItemArtworkRequestTypedDict(TypedDict):
    ...
    r"""The marketplace on which the client application is distributed"""
    url: NotRequired[str]
    r"""The url of the new asset."""


class UpdateItemArtworkRequest(BaseModel):
    ids: Annotated[
...
class UpdateItemArtworkResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateItemArtworkResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
