...
from plex_api_client.models.components import (
    ...
    progressresponse as components_progressresponse,
)
...
class GetProgressGlobalsTypedDict(TypedDict):
...
class GetProgressGlobals(BaseModel):
    accepts: Annotated[
...
class GetProgressRequestTypedDict(TypedDict):
    key: str
    r"""The metadata key of the item"""
    time: int
    r"""The current playback position in milliseconds"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetProgressResponseTypedDict(TypedDict):
    content_type: str
    ...
    progress_response: NotRequired[
        components_progressresponse.ProgressResponseTypedDict
    ]
    r"""OK"""
...
class GetProgressResponse(BaseModel):
    ...
    progress_response: Optional[components_progressresponse.ProgressResponse] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["ProgressResponse"])
        serialized = handler(self)
        m = {}
