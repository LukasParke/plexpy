...
from plex_api_client.models.components import (
    ...
    composite as components_composite,
)
...
class GetCollectionImageGlobalsTypedDict(TypedDict):
...
class GetCollectionImageGlobals(BaseModel):
    accepts: Annotated[
...
class GetCollectionImageRequestTypedDict(TypedDict):
    collection_id: int
    r"""The collection id"""
    updated_at: int
    r"""The update time of the image.  Used for busting cache."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetCollectionImageRequest(BaseModel):
    ...
    composite: Annotated[
        Optional[components_composite.Composite],
...
class GetCollectionImageResponseTypedDict(TypedDict):
    content_type: str
...
class GetCollectionImageResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
