...
from plex_api_client.models.components import (
    ...
    serveruserfeaturesresponse as components_serveruserfeaturesresponse,
)
...
class GetServerUserFeaturesGlobalsTypedDict(TypedDict):
...
class GetServerUserFeaturesGlobals(BaseModel):
    accepts: Annotated[
...
class GetServerUserFeaturesRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetServerUserFeaturesRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetServerUserFeaturesResponseTypedDict(TypedDict):
    content_type: str
    ...
    server_user_features_response: NotRequired[
        components_serveruserfeaturesresponse.ServerUserFeaturesResponseTypedDict
    ]
    r"""OK"""


class GetServerUserFeaturesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    server_user_features_response: Optional[
        components_serveruserfeaturesresponse.ServerUserFeaturesResponse
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["ServerUserFeaturesResponse"])
        serialized = handler(self)
        m = {}
