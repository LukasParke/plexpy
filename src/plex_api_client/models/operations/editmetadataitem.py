...
class EditMetadataItemGlobalsTypedDict(TypedDict):
...
class EditMetadataItemGlobals(BaseModel):
    accepts: Annotated[
...
class ArgsTypedDict(TypedDict):
    r"""The new values for the metadata item"""
...
class EditMetadataItemRequestTypedDict(TypedDict):
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    args: NotRequired[ArgsTypedDict]
    r"""The new values for the metadata item"""


class EditMetadataItemRequest(BaseModel):
    ids: Annotated[
...
class EditMetadataItemResponseTypedDict(TypedDict):
    content_type: str
...
class EditMetadataItemResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
