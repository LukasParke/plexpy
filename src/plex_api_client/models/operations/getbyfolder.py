...
class GetByFolderGlobalsTypedDict(TypedDict):
...
class GetByFolderGlobals(BaseModel):
    accepts: Annotated[
...
class GetByFolderRequestTypedDict(TypedDict):
    section_id: int
...
class GetByFolderRequest(BaseModel):
...
class GetByFolderResponseTypedDict(TypedDict):
    content_type: str
...
class GetByFolderResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
