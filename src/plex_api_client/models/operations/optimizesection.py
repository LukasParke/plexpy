...
class OptimizeSectionGlobalsTypedDict(TypedDict):
...
class OptimizeSectionGlobals(BaseModel):
    accepts: Annotated[
...
class OptimizeSectionRequestTypedDict(TypedDict):
    section_id: int
...
class OptimizeSectionResponseTypedDict(TypedDict):
    content_type: str
