...
SkipParentTypedDict = TypeAliasType("SkipParentTypedDict", Union[bool, SkipParent2])
r"""When present on an episode or track item, indicates parent should be skipped in favor of grandparent (show)."""


SkipParent = TypeAliasType("SkipParent", Union[bool, SkipParent2])
r"""When present on an episode or track item, indicates parent should be skipped in favor of grandparent (show)."""
...
class MetadataTypedDict(TypedDict):
    ...
    player: NotRequired[components_player.PlayerTypedDict]
    ...
    user: NotRequired[components_user.UserTypedDict]
    ...
    skip_children: NotRequired[SkipChildrenTypedDict]
    r"""When found on a show item, indicates that the children (seasons) should be skipped in favor of the grandchildren (episodes). Useful for mini-series, etc."""
    skip_parent: NotRequired[SkipParentTypedDict]
    r"""When present on an episode or track item, indicates parent should be skipped in favor of grandparent (show)."""
...
class Metadata(BaseModel):
    ...
    player: Annotated[
        Optional[components_player.Player], pydantic.Field(alias="Player")
    ] = None
    r"""Information about the player being used for playback"""

    session: Annotated[
        Optional[components_session.Session], pydantic.Field(alias="Session")
    ] = None
    r"""Information about the playback session"""

    user: Annotated[Optional[components_user.User], pydantic.Field(alias="User")] = None
    r"""The user playing the content"""
    ...
    skip_children: Annotated[
        Optional[SkipChildren], pydantic.Field(alias="skipChildren")
    ] = None
    r"""When found on a show item, indicates that the children (seasons) should be skipped in favor of the grandchildren (episodes). Useful for mini-series, etc."""

    skip_parent: Annotated[Optional[SkipParent], pydantic.Field(alias="skipParent")] = (
        None
    )
    r"""When present on an episode or track item, indicates parent should be skipped in favor of grandparent (show)."""
...
class ListSessionsMediaContainerTypedDict(TypedDict):
...
class ListSessionsMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
...
class ListSessionsResponseBodyTypedDict(TypedDict):
    ...
    media_container: NotRequired[ListSessionsMediaContainerTypedDict]
...
class ListSessionsResponseBody(BaseModel):
    ...
    media_container: Annotated[
        Optional[ListSessionsMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None
...
class ListSessionsResponseTypedDict(TypedDict):
    ...
    object: NotRequired[ListSessionsResponseBodyTypedDict]
    r"""OK"""
...
class ListSessionsResponse(BaseModel):
    ...
    object: Optional[ListSessionsResponseBody] = None
    r"""OK"""
...
try:
    ...
    pass
try:
    ListSessionsMediaContainer.model_rebuild()
except NameError:
    pass
try:
    ListSessionsResponseBody.model_rebuild()
except NameError:
    pass
