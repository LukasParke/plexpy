...
from plex_api_client.models.components import (
    ...
    dvrrequesthandler_slash_get_responses_200 as components_dvrrequesthandler_slash_get_responses_200,
)
...
class CreateDVRGlobalsTypedDict(TypedDict):
...
class CreateDVRGlobals(BaseModel):
    accepts: Annotated[
...
class CreateDVRRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""The EPG lineup."""
    device_query_parameter: NotRequired[List[str]]
    r"""The device."""
    language: NotRequired[str]
    r"""The language."""


class CreateDVRRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class CreateDVRResponseTypedDict(TypedDict):
    content_type: str
...
class CreateDVRResponse(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["dvrRequestHandler_slash-get-responses-200"])
        serialized = handler(self)
        m = {}
