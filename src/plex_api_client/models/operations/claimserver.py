...
class ClaimServerGlobalsTypedDict(TypedDict):
...
class ClaimServerGlobals(BaseModel):
    accepts: Annotated[
...
class ClaimServerRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class ClaimServerResponseTypedDict(TypedDict):
    content_type: str
...
class ClaimServerResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
