...
class GetExtrasGlobalsTypedDict(TypedDict):
...
class GetExtrasGlobals(BaseModel):
    accepts: Annotated[
...
class GetExtrasRequestTypedDict(TypedDict):
    ids: str
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
...
class GetExtrasRequest(BaseModel):
    ids: Annotated[
...
class GetExtrasResponseTypedDict(TypedDict):
    content_type: str
...
class GetExtrasResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
