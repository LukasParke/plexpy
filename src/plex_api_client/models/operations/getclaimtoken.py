...
from plex_api_client.models.components import (
    ...
    claimtokenresponse as components_claimtokenresponse,
)
...
class GetClaimTokenGlobalsTypedDict(TypedDict):
...
class GetClaimTokenGlobals(BaseModel):
    accepts: Annotated[
...
class GetClaimTokenRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetClaimTokenRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetClaimTokenResponseTypedDict(TypedDict):
    content_type: str
    ...
    claim_token_response: NotRequired[
        components_claimtokenresponse.ClaimTokenResponseTypedDict
    ]
    r"""OK"""


class GetClaimTokenResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    claim_token_response: Optional[components_claimtokenresponse.ClaimTokenResponse] = (
        None
    )
    r"""OK"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["ClaimTokenResponse"])
        serialized = handler(self)
        m = {}
