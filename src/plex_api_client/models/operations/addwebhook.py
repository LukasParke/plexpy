...
class AddWebhookGlobalsTypedDict(TypedDict):
...
class AddWebhookGlobals(BaseModel):
    accepts: Annotated[
...
class AddWebhookRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class AddWebhookResponseTypedDict(TypedDict):
    content_type: str
