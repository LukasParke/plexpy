...
class PlayerPauseGlobalsTypedDict(TypedDict):
...
class PlayerPauseGlobals(BaseModel):
    accepts: Annotated[
...
class PlayerPauseRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class PlayerPauseResponseTypedDict(TypedDict):
    content_type: str
...
class PlayerPauseResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
