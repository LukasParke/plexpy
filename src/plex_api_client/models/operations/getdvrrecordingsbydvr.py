...
class GetDVRRecordingsByDVRGlobalsTypedDict(TypedDict):
...
class GetDVRRecordingsByDVRGlobals(BaseModel):
    accepts: Annotated[
...
class GetDVRRecordingsByDVRRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class GetDVRRecordingsByDVRRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class GetDVRRecordingsByDVRResponseTypedDict(TypedDict):
    content_type: str
...
class GetDVRRecordingsByDVRResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
