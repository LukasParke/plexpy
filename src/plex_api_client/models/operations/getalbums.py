...
class GetAlbumsGlobalsTypedDict(TypedDict):
...
class GetAlbumsGlobals(BaseModel):
    accepts: Annotated[
...
class GetAlbumsRequestTypedDict(TypedDict):
    section_id: int
...
class GetAlbumsResponseTypedDict(TypedDict):
    content_type: str
