...
from plex_api_client.models.components import (
    ...
    managedhub as components_managedhub,
)
...
class ListHubsMediaContainerTypedDict(TypedDict):
    ...
    hub: NotRequired[List[components_managedhub.ManagedHubTypedDict]]
...
class ListHubsMediaContainer(BaseModel):
    ...
    hub: Annotated[
        Optional[List[components_managedhub.ManagedHub]], pydantic.Field(alias="Hub")
    ] = None
...
try:
    ListHubsMediaContainer.model_rebuild()
except NameError:
    pass
try:
    ListHubsResponseBody.model_rebuild()
except NameError:
    pass
