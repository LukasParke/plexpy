...
class GetThumbGlobalsTypedDict(TypedDict):
...
class GetThumbGlobals(BaseModel):
    accepts: Annotated[
...
class GetThumbRequestTypedDict(TypedDict):
    device_id: int
    r"""The ID of the device."""
    version_path_parameter: int
    r"""A version number of the thumb used for busting cache"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetThumbRequest(BaseModel):
    device_id: Annotated[
        int,
    ...
    version_path_parameter: Annotated[
        int,
...
class GetThumbResponseTypedDict(TypedDict):
    content_type: str
