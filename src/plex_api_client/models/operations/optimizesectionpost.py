...
class OptimizeSectionPostGlobalsTypedDict(TypedDict):
...
class OptimizeSectionPostGlobals(BaseModel):
    accepts: Annotated[
...
class OptimizeSectionPostRequestTypedDict(TypedDict):
    section_id: int
...
class OptimizeSectionPostRequest(BaseModel):
...
class OptimizeSectionPostResponseTypedDict(TypedDict):
    content_type: str
...
class OptimizeSectionPostResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
