...
class GetChapterImageGlobalsTypedDict(TypedDict):
...
class GetChapterImageGlobals(BaseModel):
    accepts: Annotated[
...
class GetChapterImageRequestTypedDict(TypedDict):
    media_id: int
    r"""The id of the media item"""
    chapter: int
    r"""The index of the chapter"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetChapterImageRequest(BaseModel):
    media_id: Annotated[
        int,
...
class GetChapterImageResponseTypedDict(TypedDict):
    content_type: str
...
class GetChapterImageResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
