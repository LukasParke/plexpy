...
class EditSubscriptionPreferencesGlobalsTypedDict(TypedDict):
...
class EditSubscriptionPreferencesGlobals(BaseModel):
    accepts: Annotated[
...
class EditSubscriptionPreferencesResponseTypedDict(TypedDict):
    content_type: str
...
class EditSubscriptionPreferencesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
