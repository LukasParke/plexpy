...
class GetSectionEpisodesGlobalsTypedDict(TypedDict):
...
class GetSectionEpisodesGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionEpisodesRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionEpisodesRequest(BaseModel):
...
class GetSectionEpisodesResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionEpisodesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
