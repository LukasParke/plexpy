...
class CancelGrabGlobalsTypedDict(TypedDict):
...
class CancelGrabGlobals(BaseModel):
    accepts: Annotated[
...
class CancelGrabRequestTypedDict(TypedDict):
    operation_id: str
...
class CancelGrabRequest(BaseModel):
...
class CancelGrabResponseTypedDict(TypedDict):
    content_type: str
...
class CancelGrabResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
