...
import httpx
from plex_api_client.models.components import transcodejob as components_transcodejob
...
class GetBackgroundTasksMediaContainerTypedDict(TypedDict):
    ...
    transcode_job: NotRequired[List[components_transcodejob.TranscodeJobTypedDict]]
...
class GetBackgroundTasksMediaContainer(BaseModel):
    ...
    transcode_job: Annotated[
        Optional[List[components_transcodejob.TranscodeJob]],
        pydantic.Field(alias="TranscodeJob"),
    ] = None
