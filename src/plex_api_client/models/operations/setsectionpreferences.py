...
class SetSectionPreferencesGlobalsTypedDict(TypedDict):
...
class SetSectionPreferencesGlobals(BaseModel):
    accepts: Annotated[
...
class SetSectionPreferencesRequest(BaseModel):
...
class SetSectionPreferencesResponseTypedDict(TypedDict):
    content_type: str
...
class SetSectionPreferencesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
