...
class ListTopUsersGlobalsTypedDict(TypedDict):
...
class ListTopUsersRequest(BaseModel):
    ids: Annotated[
...
class ListTopUsersMediaContainer(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["identifier", "offset", "size", "totalSize", "Account"])
        serialized = handler(self)
        m = {}
...
class ListTopUsersResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[ListTopUsersMediaContainerTypedDict]


class ListTopUsersResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[ListTopUsersMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None
...
class ListTopUsersResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[ListTopUsersResponseBodyTypedDict]
    r"""OK"""


class ListTopUsersResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    object: Optional[ListTopUsersResponseBody] = None
    r"""OK"""
...
try:
    ...
    pass
try:
    ListTopUsersResponseBody.model_rebuild()
except NameError:
    pass
