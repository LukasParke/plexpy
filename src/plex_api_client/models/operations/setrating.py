...
class SetRatingGlobalsTypedDict(TypedDict):
...
class SetRatingGlobals(BaseModel):
    accepts: Annotated[
...
class SetRatingRequestTypedDict(TypedDict):
    identifier: str
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    rated_at: NotRequired[int]
    r"""The time when the rating occurred.  If not present, interpreted as now."""
...
class SetRatingResponseTypedDict(TypedDict):
    content_type: str
