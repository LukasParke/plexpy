...
class SetStreamOffsetGlobalsTypedDict(TypedDict):
...
class SetStreamOffsetGlobals(BaseModel):
    accepts: Annotated[
...
class SetStreamOffsetRequestTypedDict(TypedDict):
    stream_id: int
    r"""The id of the stream"""
    ext: str
    r"""This is not a part of this endpoint but documented here to satisfy OpenAPI"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class SetStreamOffsetRequest(BaseModel):
    stream_id: Annotated[
        int,
...
class SetStreamOffsetResponseTypedDict(TypedDict):
    content_type: str
...
class SetStreamOffsetResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
