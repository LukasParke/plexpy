...
class ListMomentsGlobalsTypedDict(TypedDict):
...
class ListMomentsGlobals(BaseModel):
    accepts: Annotated[
...
class ListMomentsRequestTypedDict(TypedDict):
    section_id: int
...
class ListMomentsResponseTypedDict(TypedDict):
    content_type: str
...
class ListMomentsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
