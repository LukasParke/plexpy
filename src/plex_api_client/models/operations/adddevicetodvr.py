...
class AddDeviceToDVRGlobalsTypedDict(TypedDict):
...
class AddDeviceToDVRGlobals(BaseModel):
    accepts: Annotated[
...
class AddDeviceToDVRRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class AddDeviceToDVRDVRsMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
...
class AddDeviceToDVRDVR(BaseModel):
    device: Annotated[
...
class AddDeviceToDVRMediaContainerTypedDict(TypedDict):
    ...
    dvr: NotRequired[List[AddDeviceToDVRDVRTypedDict]]


class AddDeviceToDVRMediaContainer(BaseModel):
    media_container: Annotated[
        Optional[AddDeviceToDVRDVRsMediaContainer],
        pydantic.Field(alias="MediaContainer"),
    ] = None

    dvr: Annotated[Optional[List[AddDeviceToDVRDVR]], pydantic.Field(alias="DVR")] = (
        None
    )
...
class AddDeviceToDVRResponseBodyTypedDict(TypedDict):
    ...
    media_container: NotRequired[AddDeviceToDVRMediaContainerTypedDict]


class AddDeviceToDVRResponseBody(BaseModel):
    r"""OK"""
...
class AddDeviceToDVRResponseTypedDict(TypedDict):
    ...
    object: NotRequired[AddDeviceToDVRResponseBodyTypedDict]
    r"""OK"""


class AddDeviceToDVRResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
