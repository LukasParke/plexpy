...
class ListLineupsGlobalsTypedDict(TypedDict):
...
class ListLineupsGlobals(BaseModel):
    accepts: Annotated[
...
class ListLineupsRequestTypedDict(TypedDict):
    country: str
    r"""3 letter country code"""
    epg_id: str
    r"""The `providerIdentifier` of the provider"""
    region: str
    r"""The region for the lineup"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class ListLineupsRequest(BaseModel):
    country: Annotated[
...
class ListLineupsResponseTypedDict(TypedDict):
    content_type: str
...
class ListLineupsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
