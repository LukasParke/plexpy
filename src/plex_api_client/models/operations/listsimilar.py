...
class ListSimilarGlobalsTypedDict(TypedDict):
...
class ListSimilarGlobals(BaseModel):
    accepts: Annotated[
...
class ListSimilarRequestTypedDict(TypedDict):
    ids: str
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
...
class ListSimilarRequest(BaseModel):
    ids: Annotated[
...
class ListSimilarResponseTypedDict(TypedDict):
    content_type: str
...
class ListSimilarResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
