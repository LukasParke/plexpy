...
class TriggerFallbackGlobalsTypedDict(TypedDict):
...
class TriggerFallbackGlobals(BaseModel):
    accepts: Annotated[
...
class TriggerFallbackRequestTypedDict(TypedDict):
...
class TriggerFallbackResponseTypedDict(TypedDict):
    content_type: str
...
class TriggerFallbackResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
