...
class UpdateHomeUserGlobalsTypedDict(TypedDict):
...
class UpdateHomeUserGlobals(BaseModel):
    accepts: Annotated[
...
class UpdateHomeUserRequestTypedDict(TypedDict):
    user_id: int
...
class UpdateHomeUserRequest(BaseModel):
    user_id: Annotated[
        int,
...
class UpdateHomeUserResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateHomeUserResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
