...
from plex_api_client.models.components import (
    ...
    tokenexchangerequest as components_tokenexchangerequest,
)
...
class ExchangeJWTTokenGlobalsTypedDict(TypedDict):
...
class ExchangeJWTTokenGlobals(BaseModel):
    accepts: Annotated[
...
class ExchangeJWTTokenRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    token_exchange_request: NotRequired[
        components_tokenexchangerequest.TokenExchangeRequestTypedDict
    ]


class ExchangeJWTTokenRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
    ...
    token_exchange_request: Annotated[
        Optional[components_tokenexchangerequest.TokenExchangeRequest],
...
class ExchangeJWTTokenResponseTypedDict(TypedDict):
    content_type: str
...
class ExchangeJWTTokenResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
