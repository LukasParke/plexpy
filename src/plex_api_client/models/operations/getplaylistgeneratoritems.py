...
class GetPlaylistGeneratorItemsGuidsTypedDict(TypedDict):
    id: str
...
class GetPlaylistGeneratorItemsGuids(BaseModel):
    id: str
    r"""The unique identifier for the Guid. Can be prefixed with imdb://, tmdb://, tvdb://
...
class GetPlaylistGeneratorItemsMetadataTypedDict(TypedDict):
    ...
    guids: NotRequired[List[GetPlaylistGeneratorItemsGuidsTypedDict]]
...
class GetPlaylistGeneratorItemsMetadata(BaseModel):
    ...
    guids: Annotated[
        Optional[List[GetPlaylistGeneratorItemsGuids]], pydantic.Field(alias="Guid")
    ] = None
...
try:
    GetPlaylistGeneratorItemsMetadata.model_rebuild()
except NameError:
    pass
try:
    GetPlaylistGeneratorItemsMediaContainer.model_rebuild()
except NameError:
    pass
try:
    GetPlaylistGeneratorItemsResponseBody.model_rebuild()
except NameError:
    pass
