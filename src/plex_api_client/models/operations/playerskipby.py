...
class PlayerSkipByGlobalsTypedDict(TypedDict):
...
class PlayerSkipByGlobals(BaseModel):
    accepts: Annotated[
...
class PlayerSkipByRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""Number of items to skip (positive for forward, negative for backward)"""


class PlayerSkipByRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class PlayerSkipByResponseTypedDict(TypedDict):
    content_type: str
...
class PlayerSkipByResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
