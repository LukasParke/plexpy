...
from plex_api_client.models.components import (
    ...
    userplexaccount as components_userplexaccount,
)
...
class GetAccountJSONGlobalsTypedDict(TypedDict):
...
class GetAccountJSONGlobals(BaseModel):
    accepts: Annotated[
...
class GetAccountJSONRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetAccountJSONRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetAccountJSONResponseTypedDict(TypedDict):
    content_type: str
    ...
    user_plex_account: NotRequired[components_userplexaccount.UserPlexAccountTypedDict]
    r"""OK"""


class GetAccountJSONResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    user_plex_account: Optional[components_userplexaccount.UserPlexAccount] = None
    r"""OK"""
