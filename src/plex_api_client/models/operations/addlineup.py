...
class AddLineupGlobalsTypedDict(TypedDict):
...
class AddLineupGlobals(BaseModel):
    accepts: Annotated[
...
class AddLineupRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    lineup: str
...
class AddLineupDVRsMediaContainerTypedDict(TypedDict):
...
class AddLineupDVRsMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
...
class AddLineupDVRTypedDict(TypedDict):
...
class AddLineupMediaContainerTypedDict(TypedDict):
    media_container: NotRequired[AddLineupDVRsMediaContainerTypedDict]
    dvr: NotRequired[List[AddLineupDVRTypedDict]]


class AddLineupMediaContainer(BaseModel):
    media_container: Annotated[
        Optional[AddLineupDVRsMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None

    dvr: Annotated[Optional[List[AddLineupDVR]], pydantic.Field(alias="DVR")] = None
...
class AddLineupResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[AddLineupMediaContainerTypedDict]


class AddLineupResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[AddLineupMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None
...
class AddLineupResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[AddLineupResponseBodyTypedDict]
    r"""OK"""
...
class AddLineupResponse(BaseModel):
    ...
    object: Optional[AddLineupResponseBody] = None
    r"""OK"""
...
try:
    AddLineupDVRsMediaContainer.model_rebuild()
except NameError:
    pass
try:
    AddLineupDVR.model_rebuild()
except NameError:
    pass
try:
    AddLineupMediaContainer.model_rebuild()
except NameError:
    pass
try:
    AddLineupResponseBody.model_rebuild()
except NameError:
    pass
