...
import httpx
from plex_api_client.models.components import downloadqueue as components_downloadqueue
...
class CreateDownloadQueueMediaContainerTypedDict(TypedDict):
    ...
    download_queue: NotRequired[List[components_downloadqueue.DownloadQueueTypedDict]]
...
class CreateDownloadQueueMediaContainer(BaseModel):
    ...
    download_queue: Annotated[
        Optional[List[components_downloadqueue.DownloadQueue]],
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["identifier", "offset", "size", "totalSize", "DownloadQueue"]
        )
...
try:
    CreateDownloadQueueMediaContainer.model_rebuild()
except NameError:
    pass
try:
    CreateDownloadQueueResponseBody.model_rebuild()
except NameError:
    pass
