...
class GetMetadataReviewsGlobalsTypedDict(TypedDict):
...
class GetMetadataReviewsGlobals(BaseModel):
    accepts: Annotated[
...
class GetMetadataReviewsRequestTypedDict(TypedDict):
    id: int
...
class GetMetadataReviewsRequest(BaseModel):
    id: Annotated[
...
class GetMetadataReviewsResponseTypedDict(TypedDict):
    content_type: str
...
class GetMetadataReviewsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
