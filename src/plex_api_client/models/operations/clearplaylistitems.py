...
class ClearPlaylistItemsGlobalsTypedDict(TypedDict):
...
class ClearPlaylistItemsGlobals(BaseModel):
    accepts: Annotated[
...
class ClearPlaylistItemsRequestTypedDict(TypedDict):
    playlist_id: int
...
class ClearPlaylistItemsRequest(BaseModel):
...
class ClearPlaylistItemsResponseTypedDict(TypedDict):
    content_type: str
