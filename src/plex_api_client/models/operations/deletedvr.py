...
class DeleteDVRGlobalsTypedDict(TypedDict):
...
class DeleteDVRRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class DeleteDVRRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class DeleteDVRResponseTypedDict(TypedDict):
    content_type: str
...
class DeleteDVRResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
