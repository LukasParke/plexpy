...
class EmptyTrashPostGlobalsTypedDict(TypedDict):
...
class EmptyTrashPostGlobals(BaseModel):
    accepts: Annotated[
...
class EmptyTrashPostRequestTypedDict(TypedDict):
    section_id: int
...
class EmptyTrashPostRequest(BaseModel):
...
class EmptyTrashPostResponseTypedDict(TypedDict):
    content_type: str
...
class EmptyTrashPostResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
