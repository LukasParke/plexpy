...
class GetSectionArtistsGlobalsTypedDict(TypedDict):
...
class GetSectionArtistsGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionArtistsRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionArtistsRequest(BaseModel):
...
class GetSectionArtistsResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionArtistsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
