...
class GetArtsGlobalsTypedDict(TypedDict):
...
class GetArtsRequestTypedDict(TypedDict):
    section_id: int
...
class GetArtsRequest(BaseModel):
...
class GetArtsResponseTypedDict(TypedDict):
    content_type: str
...
class GetArtsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
