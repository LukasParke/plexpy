...
class GetRelatedHubsGlobalsTypedDict(TypedDict):
...
class GetRelatedHubsGlobals(BaseModel):
    accepts: Annotated[
...
class GetRelatedHubsRequestTypedDict(TypedDict):
    metadata_id: int
...
class GetRelatedHubsRequest(BaseModel):
...
class GetRelatedHubsResponseTypedDict(TypedDict):
    content_type: str
