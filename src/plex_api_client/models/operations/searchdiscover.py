...
class SearchDiscoverGlobalsTypedDict(TypedDict):
...
class SearchDiscoverGlobals(BaseModel):
    accepts: Annotated[
...
class SearchDiscoverRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    search_types: NotRequired[str]
    r"""Types of content to search for"""
    search_providers: NotRequired[str]
    r"""Providers to include in the search"""
    include_metadata: NotRequired[int]
    r"""Include metadata in the search results"""
...
class SearchDiscoverRequest(BaseModel):
    ...
    search_providers: Annotated[
        Optional[str],
        pydantic.Field(alias="searchProviders"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Providers to include in the search"""
    ...
    include_metadata: Annotated[
        Optional[int],
        pydantic.Field(alias="includeMetadata"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = 1
    r"""Include metadata in the search results"""
...
class SearchDiscoverResponseTypedDict(TypedDict):
    content_type: str
