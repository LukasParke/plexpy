...
class TerminateSessionGlobalsTypedDict(TypedDict):
...
class TerminateSessionGlobals(BaseModel):
    accepts: Annotated[
...
class TerminateSessionRequestTypedDict(TypedDict):
    session_id: str
    r"""The session id (found in the `Session` element in [/status/sessions](#tag/Status/operation/statusGetSlash))"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""The reason to give to the user (typically displayed in the client)"""
...
class TerminateSessionResponseTypedDict(TypedDict):
    content_type: str
