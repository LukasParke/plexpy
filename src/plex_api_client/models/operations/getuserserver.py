...
class GetUserServerGlobalsTypedDict(TypedDict):
...
class GetUserServerGlobals(BaseModel):
    accepts: Annotated[
...
class GetUserServerRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetUserServerRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetUserServerResponseTypedDict(TypedDict):
    content_type: str
    ...
    connection_info: NotRequired[components_connectioninfo.ConnectionInfoTypedDict]
    r"""OK"""


class GetUserServerResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    connection_info: Optional[components_connectioninfo.ConnectionInfo] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["ConnectionInfo"])
        serialized = handler(self)
        m = {}
