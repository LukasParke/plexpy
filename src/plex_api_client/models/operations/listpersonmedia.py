...
class ListPersonMediaGlobalsTypedDict(TypedDict):
...
class ListPersonMediaGlobals(BaseModel):
    accepts: Annotated[
...
class ListPersonMediaRequestTypedDict(TypedDict):
    person_id: str
...
class ListPersonMediaRequest(BaseModel):
    person_id: Annotated[
        str,
...
class ListPersonMediaResponseTypedDict(TypedDict):
    content_type: str
...
class ListPersonMediaResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
