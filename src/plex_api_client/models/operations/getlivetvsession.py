...
class GetLiveTVSessionGlobalsTypedDict(TypedDict):
...
class GetLiveTVSessionGlobals(BaseModel):
    accepts: Annotated[
...
class GetLiveTVSessionRequestTypedDict(TypedDict):
    session_id: str
    r"""The session id"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class GetLiveTVSessionRequest(BaseModel):
...
class GetLiveTVSessionResponseTypedDict(TypedDict):
    content_type: str
...
class GetLiveTVSessionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
