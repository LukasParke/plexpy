...
class DeleteCustomHubGlobalsTypedDict(TypedDict):
...
class DeleteCustomHubGlobals(BaseModel):
    accepts: Annotated[
...
class DeleteCustomHubRequestTypedDict(TypedDict):
    section_id: int
...
class DeleteCustomHubRequest(BaseModel):
...
class DeleteCustomHubResponseTypedDict(TypedDict):
    content_type: str
...
class DeleteCustomHubResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
