...
class GetSectionEditGlobalsTypedDict(TypedDict):
...
class GetSectionEditGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionEditRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionEditRequest(BaseModel):
...
class GetSectionEditResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionEditResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
