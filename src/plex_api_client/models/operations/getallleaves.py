...
class GetAllLeavesGlobalsTypedDict(TypedDict):
...
class GetAllLeavesGlobals(BaseModel):
    accepts: Annotated[
...
class GetAllLeavesRequestTypedDict(TypedDict):
    section_id: int
...
class GetAllLeavesRequest(BaseModel):
...
class GetAllLeavesResponseTypedDict(TypedDict):
    content_type: str
...
class GetAllLeavesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
