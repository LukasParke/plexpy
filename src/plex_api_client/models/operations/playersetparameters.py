...
class PlayerSetParametersGlobalsTypedDict(TypedDict):
...
class PlayerSetParametersGlobals(BaseModel):
    accepts: Annotated[
...
class Shuffle(int, Enum):
    r"""Whether to enable shuffle mode"""

    ZERO = 0
    ONE = 1


class Repeat(int, Enum):
    r"""The repeat mode to set"""
...
class PlayerSetParametersRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    shuffle: NotRequired[Shuffle]
    r"""Whether to enable shuffle mode"""
    repeat: NotRequired[Repeat]
    r"""The repeat mode to set"""
    volume: NotRequired[int]
    r"""The volume level to set"""


class PlayerSetParametersRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class PlayerSetParametersResponseTypedDict(TypedDict):
    content_type: str
...
class PlayerSetParametersResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
