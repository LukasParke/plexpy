...
class SearchSectionGlobalsTypedDict(TypedDict):
...
class SearchSectionGlobals(BaseModel):
    accepts: Annotated[
...
class SearchSectionRequestTypedDict(TypedDict):
    section_id: int
...
class SearchSectionResponseTypedDict(TypedDict):
    content_type: str
