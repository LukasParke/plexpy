...
from plex_api_client.models.components import (
    ...
    authnonceresponse as components_authnonceresponse,
)
...
class GetAuthNonceGlobalsTypedDict(TypedDict):
...
class GetAuthNonceGlobals(BaseModel):
    accepts: Annotated[
...
class GetAuthNonceRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetAuthNonceRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetAuthNonceResponseTypedDict(TypedDict):
    content_type: str
    ...
    auth_nonce_response: NotRequired[
        components_authnonceresponse.AuthNonceResponseTypedDict
    ]
    r"""OK"""


class GetAuthNonceResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    auth_nonce_response: Optional[components_authnonceresponse.AuthNonceResponse] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["AuthNonceResponse"])
        serialized = handler(self)
        m = {}
