...
class OptimizeDatabaseGlobalsTypedDict(TypedDict):
...
class OptimizeDatabaseGlobals(BaseModel):
    accepts: Annotated[
...
class OptimizeDatabaseRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class OptimizeDatabaseResponseTypedDict(TypedDict):
    content_type: str
