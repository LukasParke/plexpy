...
class UnscrobbleGlobalsTypedDict(TypedDict):
...
class UnscrobbleGlobals(BaseModel):
    accepts: Annotated[
...
class UnscrobbleResponseTypedDict(TypedDict):
    content_type: str
...
class UnscrobbleResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
