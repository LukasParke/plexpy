...
class SetStreamSelectionGlobalsTypedDict(TypedDict):
...
class SetStreamSelectionGlobals(BaseModel):
    accepts: Annotated[
...
class SetStreamSelectionRequestTypedDict(TypedDict):
    part_id: int
    r"""The id of the part to select streams on"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""The id of the audio stream to select in this part"""
    subtitle_stream_id: NotRequired[int]
    r"""The id of the subtitle stream to select in this part.  Specify 0 to select no subtitle"""
    all_parts: NotRequired[components_boolint.BoolInt]
    r"""Perform the same for all parts of this media selecting similar streams in each"""


class SetStreamSelectionRequest(BaseModel):
    part_id: Annotated[
        int,
...
class SetStreamSelectionResponseTypedDict(TypedDict):
    content_type: str
...
class SetStreamSelectionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
