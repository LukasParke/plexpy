...
from plex_api_client.models.components import (
    ...
    get_responses_200 as components_get_responses_200,
)
...
class MoveHubGlobalsTypedDict(TypedDict):
...
class MoveHubGlobals(BaseModel):
    accepts: Annotated[
...
class MoveHubRequestTypedDict(TypedDict):
    section_id: int
    r"""The section ID for the hubs to reorder"""
    identifier: str
    r"""The identifier of the hub to move"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""The identifier of the hub to order this hub after (or empty/missing to put this hub first)"""
...
class MoveHubResponseTypedDict(TypedDict):
    content_type: str
...
class MoveHubResponse(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["get-responses-200"])
        serialized = handler(self)
        m = {}
