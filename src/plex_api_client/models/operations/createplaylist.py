...
class CreatePlaylistGlobalsTypedDict(TypedDict):
...
class CreatePlaylistGlobals(BaseModel):
    accepts: Annotated[
...
class CreatePlaylistRequestTypedDict(TypedDict):
    ...
    r"""The marketplace on which the client application is distributed"""
    uri: NotRequired[str]
    r"""The content URI for what we're playing (e.g. `library://...`)."""
    play_queue_id: NotRequired[int]
    r"""To create a playlist from an existing play queue."""
