...
class GetByYearGlobalsTypedDict(TypedDict):
...
class GetByYearGlobals(BaseModel):
    accepts: Annotated[
...
class GetByYearRequestTypedDict(TypedDict):
    section_id: int
...
class GetByYearRequest(BaseModel):
...
class GetByYearResponseTypedDict(TypedDict):
    content_type: str
...
class GetByYearResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
