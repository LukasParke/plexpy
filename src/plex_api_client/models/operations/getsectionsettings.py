...
class GetSectionSettingsGlobalsTypedDict(TypedDict):
...
class GetSectionSettingsGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionSettingsRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionSettingsRequest(BaseModel):
...
class GetSectionSettingsResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionSettingsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
