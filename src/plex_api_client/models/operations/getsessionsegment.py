...
class GetSessionSegmentGlobalsTypedDict(TypedDict):
...
class GetSessionSegmentGlobals(BaseModel):
    accepts: Annotated[
...
class GetSessionSegmentRequestTypedDict(TypedDict):
    session_id: str
    r"""The session id"""
    consumer_id: str
    r"""The consumer id"""
...
class GetSessionSegmentRequest(BaseModel):
...
class GetSessionSegmentResponseTypedDict(TypedDict):
    content_type: str
    ...
    r"""MPEG-TS segment for playing HLS content"""


class GetSessionSegmentResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
