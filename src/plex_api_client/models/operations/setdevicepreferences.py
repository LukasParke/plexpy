...
class SetDevicePreferencesGlobalsTypedDict(TypedDict):
...
class SetDevicePreferencesRequestTypedDict(TypedDict):
    device_id: int
...
class SetDevicePreferencesResponseTypedDict(TypedDict):
    content_type: str
...
class SetDevicePreferencesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
