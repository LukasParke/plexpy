...
class GenerateThumbsGlobalsTypedDict(TypedDict):
...
class GenerateThumbsGlobals(BaseModel):
    accepts: Annotated[
...
class GenerateThumbsRequestTypedDict(TypedDict):
    ids: str
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
...
class GenerateThumbsRequest(BaseModel):
    ids: Annotated[
...
class GenerateThumbsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
