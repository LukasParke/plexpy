...
class DeletePlaylistByRatingKeyGlobalsTypedDict(TypedDict):
...
class DeletePlaylistByRatingKeyGlobals(BaseModel):
    accepts: Annotated[
...
class DeletePlaylistByRatingKeyRequestTypedDict(TypedDict):
    rating_key: int
    r"""The rating key of the playlist to delete."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class DeletePlaylistByRatingKeyRequest(BaseModel):
...
class DeletePlaylistByRatingKeyResponseTypedDict(TypedDict):
    content_type: str
...
class DeletePlaylistByRatingKeyResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
