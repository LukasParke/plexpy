...
class GetMetadataHubsGlobalsTypedDict(TypedDict):
...
class GetMetadataHubsGlobals(BaseModel):
    accepts: Annotated[
...
class GetMetadataHubsRequestTypedDict(TypedDict):
    metadata_id: int
...
class GetMetadataHubsRequest(BaseModel):
...
class GetMetadataHubsResponseTypedDict(TypedDict):
    content_type: str
