...
class DeleteHistoryGlobalsTypedDict(TypedDict):
...
class DeleteHistoryGlobals(BaseModel):
    accepts: Annotated[
...
class DeleteHistoryRequestTypedDict(TypedDict):
    history_id: int
    r"""The id of the history item (the `historyKey` from above)"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class DeleteHistoryRequest(BaseModel):
    history_id: Annotated[
        int,
        pydantic.Field(alias="historyId"),
...
class DeleteHistoryResponseTypedDict(TypedDict):
    content_type: str
...
class DeleteHistoryResponse(BaseModel):
    ...
    media_container: Optional[components_mediacontainer.MediaContainer] = None
    r"""OK"""
