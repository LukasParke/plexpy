...
class GetSectionFiltersGlobalsTypedDict(TypedDict):
...
class GetSectionFiltersGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionFiltersRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionFiltersRequest(BaseModel):
...
class GetSectionFiltersResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
