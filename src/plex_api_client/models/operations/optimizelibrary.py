...
class OptimizeLibraryGlobalsTypedDict(TypedDict):
...
class OptimizeLibraryGlobals(BaseModel):
    accepts: Annotated[
...
class OptimizeLibraryRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class OptimizeLibraryResponseTypedDict(TypedDict):
    content_type: str
...
class OptimizeLibraryResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
