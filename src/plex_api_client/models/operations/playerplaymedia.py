...
class PlayerPlayMediaGlobalsTypedDict(TypedDict):
...
class PlayerPlayMediaGlobals(BaseModel):
    accepts: Annotated[
...
class PlayerPlayMediaRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    key: NotRequired[str]
    r"""The key of the media item to play"""
    offset: NotRequired[int]
    r"""The byte offset for stream seeking"""
    machine_identifier: NotRequired[str]
    r"""The machine identifier of the target device"""


class PlayerPlayMediaRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
    ...
    machine_identifier: Annotated[
        Optional[str],
        pydantic.Field(alias="machineIdentifier"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""The machine identifier of the target device"""
...
class PlayerPlayMediaResponseTypedDict(TypedDict):
    content_type: str
...
class PlayerPlayMediaResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
