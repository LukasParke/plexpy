...
class CancelRefreshGlobalsTypedDict(TypedDict):
...
class CancelRefreshGlobals(BaseModel):
    accepts: Annotated[
...
class CancelRefreshRequestTypedDict(TypedDict):
    section_id: int
...
class CancelRefreshResponseTypedDict(TypedDict):
    content_type: str
