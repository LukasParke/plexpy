...
class SetItemArtworkGlobalsTypedDict(TypedDict):
...
class SetItemArtworkGlobals(BaseModel):
    accepts: Annotated[
...
class SetItemArtworkRequestTypedDict(TypedDict):
    ...
    r"""The marketplace on which the client application is distributed"""
    url: NotRequired[str]
    r"""The url of the new asset.  If not provided, the binary of the asset must be provided in the post body."""


class SetItemArtworkRequest(BaseModel):
    ids: Annotated[
...
class SetItemArtworkResponseTypedDict(TypedDict):
    content_type: str
...
class SetItemArtworkResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
