...
class GetPlaylistGeneratorsMediaContainer(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["identifier", "offset", "size", "totalSize", "PlayQueueGenerator"]
        )
        serialized = handler(self)
        m = {}
...
try:
    PlayQueueGenerator.model_rebuild()
except NameError:
    pass
try:
    GetPlaylistGeneratorsMediaContainer.model_rebuild()
except NameError:
    pass
try:
    GetPlaylistGeneratorsResponseBody.model_rebuild()
except NameError:
    pass
