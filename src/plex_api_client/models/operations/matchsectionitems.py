...
class MatchSectionItemsGlobalsTypedDict(TypedDict):
...
class MatchSectionItemsGlobals(BaseModel):
    accepts: Annotated[
...
class MatchSectionItemsRequestTypedDict(TypedDict):
    section_id: int
...
class MatchSectionItemsRequest(BaseModel):
...
class MatchSectionItemsResponseTypedDict(TypedDict):
    content_type: str
...
class MatchSectionItemsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
