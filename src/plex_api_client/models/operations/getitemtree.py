...
from plex_api_client.models.components import (
    ...
    mediacontainerwithnestedmetadata as components_mediacontainerwithnestedmetadata,
)
...
class GetItemTreeGlobalsTypedDict(TypedDict):
...
class GetItemTreeGlobals(BaseModel):
    accepts: Annotated[
...
class GetItemTreeRequest(BaseModel):
    ids: Annotated[
...
class GetItemTreeResponseTypedDict(TypedDict):
    content_type: str
    ...
    media_container_with_nested_metadata: NotRequired[
        components_mediacontainerwithnestedmetadata.MediaContainerWithNestedMetadataTypedDict
    ]
    r"""OK"""


class GetItemTreeResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    media_container_with_nested_metadata: Optional[
        components_mediacontainerwithnestedmetadata.MediaContainerWithNestedMetadata
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["MediaContainerWithNestedMetadata"])
        serialized = handler(self)
        m = {}
