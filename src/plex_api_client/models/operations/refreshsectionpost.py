...
class RefreshSectionPostGlobalsTypedDict(TypedDict):
...
class RefreshSectionPostGlobals(BaseModel):
    accepts: Annotated[
...
class RefreshSectionPostRequestTypedDict(TypedDict):
    section_id: int
...
class RefreshSectionPostRequest(BaseModel):
...
class RefreshSectionPostResponseTypedDict(TypedDict):
    content_type: str
...
class RefreshSectionPostResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
