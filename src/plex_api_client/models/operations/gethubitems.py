...
from plex_api_client.models.components import (
    ...
    mediacontainer as components_mediacontainer,
)
...
class GetHubItemsGlobalsTypedDict(TypedDict):
...
class GetHubItemsGlobals(BaseModel):
    accepts: Annotated[
...
class GetHubItemsRequestTypedDict(TypedDict):
    identifier: List[str]
...
class GetHubItemsRequest(BaseModel):
...
class GetHubItemsResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[components_mediacontainer.MediaContainerTypedDict]
...
class GetHubItemsResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[components_mediacontainer.MediaContainer],
...
class GetHubItemsResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[GetHubItemsResponseBodyTypedDict]
    r"""OK"""


class GetHubItemsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    object: Optional[GetHubItemsResponseBody] = None
    r"""OK"""
...
try:
    GetHubItemsResponseBody.model_rebuild()
except NameError:
    pass
