...
class CheckUpdatesGlobalsTypedDict(TypedDict):
...
class CheckUpdatesGlobals(BaseModel):
    accepts: Annotated[
...
class CheckUpdatesRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class CheckUpdatesResponseTypedDict(TypedDict):
    content_type: str
