...
class DeleteLineupGlobalsTypedDict(TypedDict):
...
class DeleteLineupGlobals(BaseModel):
    accepts: Annotated[
...
class DeleteLineupRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    lineup: str
    r"""The lineup to delete"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class DeleteLineupRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class DeleteLineupDVRsMediaContainerTypedDict(TypedDict):
...
class DeleteLineupDVRsMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
...
class DeleteLineupDVRTypedDict(TypedDict):
...
class DeleteLineupDVR(BaseModel):
    device: Annotated[
...
class DeleteLineupMediaContainerTypedDict(TypedDict):
    media_container: NotRequired[DeleteLineupDVRsMediaContainerTypedDict]
    dvr: NotRequired[List[DeleteLineupDVRTypedDict]]


class DeleteLineupMediaContainer(BaseModel):
    media_container: Annotated[
        Optional[DeleteLineupDVRsMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None

    dvr: Annotated[Optional[List[DeleteLineupDVR]], pydantic.Field(alias="DVR")] = None
...
class DeleteLineupResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[DeleteLineupMediaContainerTypedDict]


class DeleteLineupResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[DeleteLineupMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None
...
class DeleteLineupResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[DeleteLineupResponseBodyTypedDict]
    r"""OK"""
...
class DeleteLineupResponse(BaseModel):
    ...
    object: Optional[DeleteLineupResponseBody] = None
    r"""OK"""
...
try:
    DeleteLineupDVRsMediaContainer.model_rebuild()
except NameError:
    pass
try:
    DeleteLineupDVR.model_rebuild()
except NameError:
    pass
try:
    DeleteLineupMediaContainer.model_rebuild()
except NameError:
    pass
try:
    DeleteLineupResponseBody.model_rebuild()
except NameError:
    pass
