...
class GetSyncItemGlobalsTypedDict(TypedDict):
...
class GetSyncItemGlobals(BaseModel):
    accepts: Annotated[
...
class GetSyncItemRequestTypedDict(TypedDict):
    sync_id: int
    r"""The unique identifier of the sync item"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetSyncItemRequest(BaseModel):
    sync_id: Annotated[
        int,
...
class GetSyncItemResponseTypedDict(TypedDict):
    content_type: str
...
class GetSyncItemResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
