...
class GetBandwidthStatisticsGlobalsTypedDict(TypedDict):
...
class GetBandwidthStatisticsGlobals(BaseModel):
    accepts: Annotated[
...
class GetBandwidthStatisticsRequestTypedDict(TypedDict):
    ...
    r"""Dashboard timespan (1-6)"""
    account_id: NotRequired[int]
    r"""Filter by account ID"""
    device_id: NotRequired[int]
    r"""Filter by device ID"""
    lan: NotRequired[components_boolint.BoolInt]
    r"""Filter to LAN-only traffic"""
