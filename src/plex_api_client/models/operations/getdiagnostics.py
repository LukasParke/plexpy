...
class GetDiagnosticsGlobalsTypedDict(TypedDict):
...
class GetDiagnosticsGlobals(BaseModel):
    accepts: Annotated[
...
class GetDiagnosticsRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetDiagnosticsResponseTypedDict(TypedDict):
    content_type: str
