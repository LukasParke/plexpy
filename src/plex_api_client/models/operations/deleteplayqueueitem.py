...
class DeletePlayQueueItemGlobalsTypedDict(TypedDict):
...
class DeletePlayQueueItemGlobals(BaseModel):
    accepts: Annotated[
...
class DeletePlayQueueItemRequestTypedDict(TypedDict):
    play_queue_id: int
...
class DeletePlayQueueItemRequest(BaseModel):
...
class DeletePlayQueueItemResponseTypedDict(TypedDict):
    content_type: str
