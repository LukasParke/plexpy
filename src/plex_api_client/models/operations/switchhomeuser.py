...
class SwitchHomeUserGlobalsTypedDict(TypedDict):
...
class SwitchHomeUserGlobals(BaseModel):
    accepts: Annotated[
...
class SwitchHomeUserRequestTypedDict(TypedDict):
    id: int
...
class SwitchHomeUserRequest(BaseModel):
    id: Annotated[
...
class SwitchHomeUserResponseTypedDict(TypedDict):
    content_type: str
...
class SwitchHomeUserResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
