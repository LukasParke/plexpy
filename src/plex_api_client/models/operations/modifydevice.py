...
class ModifyDeviceGlobalsTypedDict(TypedDict):
...
class ModifyDeviceGlobals(BaseModel):
    accepts: Annotated[
...
class ModifyDeviceRequestTypedDict(TypedDict):
    device_id: int
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    enabled: NotRequired[components_boolint.BoolInt]
...
class ModifyDeviceMediaContainerTypedDict(TypedDict):
...
class ModifyDeviceMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["identifier", "offset", "size", "totalSize", "message", "status"]
        )
        serialized = handler(self)
        m = {}
...
class ModifyDeviceResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[ModifyDeviceMediaContainerTypedDict]


class ModifyDeviceResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[ModifyDeviceMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None
...
class ModifyDeviceResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[ModifyDeviceResponseBodyTypedDict]
    r"""OK"""


class ModifyDeviceResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    object: Optional[ModifyDeviceResponseBody] = None
    r"""OK"""
...
try:
    ModifyDeviceMediaContainer.model_rebuild()
except NameError:
    pass
try:
    ModifyDeviceResponseBody.model_rebuild()
except NameError:
    pass
