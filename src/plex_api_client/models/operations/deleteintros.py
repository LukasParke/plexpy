...
class DeleteIntrosGlobalsTypedDict(TypedDict):
...
class DeleteIntrosGlobals(BaseModel):
    accepts: Annotated[
...
class DeleteIntrosRequestTypedDict(TypedDict):
    section_id: int
...
class DeleteIntrosRequest(BaseModel):
...
class DeleteIntrosResponseTypedDict(TypedDict):
    content_type: str
...
class DeleteIntrosResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
