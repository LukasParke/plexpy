...
class GetSectionAgentsGlobalsTypedDict(TypedDict):
...
class GetSectionAgentsGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionAgentsRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionAgentsRequest(BaseModel):
...
class GetSectionAgentsResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionAgentsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
