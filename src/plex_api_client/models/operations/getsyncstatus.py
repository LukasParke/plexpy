...
from plex_api_client.models.components import (
    ...
    mediacontainerwithstatus as components_mediacontainerwithstatus,
)
...
class GetSyncStatusGlobalsTypedDict(TypedDict):
...
class GetSyncStatusGlobals(BaseModel):
    accepts: Annotated[
...
class GetSyncStatusRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetSyncStatusResponseTypedDict(TypedDict):
    content_type: str
    ...
    media_container_with_status: NotRequired[
        components_mediacontainerwithstatus.MediaContainerWithStatusTypedDict
    ]
    r"""OK"""
...
class GetSyncStatusResponse(BaseModel):
    ...
    media_container_with_status: Optional[
        components_mediacontainerwithstatus.MediaContainerWithStatus
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["MediaContainerWithStatus"])
        serialized = handler(self)
        m = {}
