...
class GetMetadataOnDeckGlobalsTypedDict(TypedDict):
...
class GetMetadataOnDeckGlobals(BaseModel):
    accepts: Annotated[
...
class GetMetadataOnDeckRequestTypedDict(TypedDict):
    id: int
...
class GetMetadataOnDeckRequest(BaseModel):
    id: Annotated[
...
class GetMetadataOnDeckResponseTypedDict(TypedDict):
    content_type: str
...
class GetMetadataOnDeckResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
