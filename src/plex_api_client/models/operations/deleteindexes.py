...
class DeleteIndexesGlobalsTypedDict(TypedDict):
...
class DeleteIndexesGlobals(BaseModel):
    accepts: Annotated[
...
class DeleteIndexesRequestTypedDict(TypedDict):
    section_id: int
...
class DeleteIndexesRequest(BaseModel):
...
class DeleteIndexesResponseTypedDict(TypedDict):
    content_type: str
...
class DeleteIndexesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
