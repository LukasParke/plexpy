...
class GetRecentlyAddedForSectionGlobalsTypedDict(TypedDict):
...
class GetRecentlyAddedForSectionGlobals(BaseModel):
    accepts: Annotated[
...
class GetRecentlyAddedForSectionRequestTypedDict(TypedDict):
    section_id: int
...
class GetRecentlyAddedForSectionRequest(BaseModel):
...
class GetRecentlyAddedForSectionResponseTypedDict(TypedDict):
    content_type: str
    ...
    r"""Recently added items"""


class GetRecentlyAddedForSectionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
