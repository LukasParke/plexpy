...
class GetUnwatchedForSectionGlobalsTypedDict(TypedDict):
...
class GetUnwatchedForSectionGlobals(BaseModel):
    accepts: Annotated[
...
class GetUnwatchedForSectionRequestTypedDict(TypedDict):
    section_id: int
...
class GetUnwatchedForSectionRequest(BaseModel):
...
class GetUnwatchedForSectionResponseTypedDict(TypedDict):
    content_type: str
...
class GetUnwatchedForSectionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
