...
class DirectoryTypedDict(TypedDict):
    ...
    r"""The filter string to view metadata wit this tag"""
    id: NotRequired[int]
    tag: NotRequired[str]
    r"""The name of the tag"""
    tag_key: NotRequired[str]
    r"""The key of this tag.  This is a universal key across all PMS instances and plex.tv services"""
    tag_type: NotRequired[int]
    r"""The type of the tag"""
    thumb: NotRequired[str]
    r"""The URL to a thumbnail for this tag"""
...
class Directory(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["filter", "id", "tag", "tagKey", "tagType", "thumb"])
        serialized = handler(self)
        m = {}
...
class GetTagsMediaContainerTypedDict(TypedDict):
...
class GetTagsMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
...
class GetTagsResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[GetTagsMediaContainerTypedDict]


class GetTagsResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[GetTagsMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None
...
class GetTagsResponseTypedDict(TypedDict):
    ...
    object: NotRequired[GetTagsResponseBodyTypedDict]
    r"""OK"""
...
class GetTagsResponse(BaseModel):
    ...
    object: Optional[GetTagsResponseBody] = None
    r"""OK"""
...
try:
    ...
    pass
try:
    GetTagsMediaContainer.model_rebuild()
except NameError:
    pass
try:
    GetTagsResponseBody.model_rebuild()
except NameError:
    pass
