...
class ReorderSubscriptionGlobalsTypedDict(TypedDict):
...
class ReorderSubscriptionGlobals(BaseModel):
    accepts: Annotated[
...
class ReorderSubscriptionRequestTypedDict(TypedDict):
    ...
    r"""The subscription to move this sub after.  If missing will insert at the beginning of the list"""
...
class ReorderSubscriptionResponseTypedDict(TypedDict):
    content_type: str
...
class ReorderSubscriptionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["MediaContainerWithSubscription"])
        serialized = handler(self)
        m = {}
