...
class UnshuffleGlobalsTypedDict(TypedDict):
...
class UnshuffleGlobals(BaseModel):
    accepts: Annotated[
...
class UnshuffleRequestTypedDict(TypedDict):
    play_queue_id: int
...
class UnshuffleRequest(BaseModel):
...
class UnshuffleResponseTypedDict(TypedDict):
    content_type: str
