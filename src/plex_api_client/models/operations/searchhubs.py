...
class SearchHubsGlobalsTypedDict(TypedDict):
...
class SearchHubsGlobals(BaseModel):
    accepts: Annotated[
...
class SearchHubsRequestTypedDict(TypedDict):
    query: str
    r"""The query term"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class SearchHubsResponseTypedDict(TypedDict):
    content_type: str
...
class SearchHubsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
