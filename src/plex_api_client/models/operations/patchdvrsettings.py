...
class PatchDVRSettingsGlobalsTypedDict(TypedDict):
...
class PatchDVRSettingsGlobals(BaseModel):
    accepts: Annotated[
...
class PatchDVRSettingsRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class PatchDVRSettingsRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class PatchDVRSettingsResponseTypedDict(TypedDict):
    content_type: str
...
class PatchDVRSettingsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
