...
class RefreshSectionsMetadataGlobalsTypedDict(TypedDict):
...
class RefreshSectionsMetadataGlobals(BaseModel):
    accepts: Annotated[
...
class RefreshSectionsMetadataRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""Force refresh of metadata"""


class RefreshSectionsMetadataRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class RefreshSectionsMetadataResponseTypedDict(TypedDict):
    content_type: str
...
class RefreshSectionsMetadataResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
