...
class GetAllSubscriptionsGlobalsTypedDict(TypedDict):
...
class GetAllSubscriptionsGlobals(BaseModel):
    accepts: Annotated[
...
class GetAllSubscriptionsRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetAllSubscriptionsResponseTypedDict(TypedDict):
    content_type: str
