...
class GetMetadataGrandparentGlobalsTypedDict(TypedDict):
...
class GetMetadataGrandparentGlobals(BaseModel):
    accepts: Annotated[
...
class GetMetadataGrandparentRequestTypedDict(TypedDict):
    id: int
...
class GetMetadataGrandparentRequest(BaseModel):
    id: Annotated[
...
class GetMetadataGrandparentResponseTypedDict(TypedDict):
    content_type: str
...
class GetMetadataGrandparentResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
