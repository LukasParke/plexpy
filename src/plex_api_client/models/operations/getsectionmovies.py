...
class GetSectionMoviesGlobalsTypedDict(TypedDict):
...
class GetSectionMoviesGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionMoviesRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionMoviesRequest(BaseModel):
...
class GetSectionMoviesResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionMoviesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
