...
class GetLineupGlobalsTypedDict(TypedDict):
...
class GetLineupGlobals(BaseModel):
    accepts: Annotated[
...
class GetLineupRequestTypedDict(TypedDict):
    ...
    lineup_group: str
    r"""The URI describing the lineupGroup"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetLineupRequest(BaseModel):
    ...
    lineup_group: Annotated[
        str,
        pydantic.Field(alias="lineupGroup"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ]
    r"""The URI describing the lineupGroup"""
...
class GetLineupResponseTypedDict(TypedDict):
    content_type: str
