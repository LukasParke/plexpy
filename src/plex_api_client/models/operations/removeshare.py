...
class RemoveShareGlobalsTypedDict(TypedDict):
...
class RemoveShareGlobals(BaseModel):
    accepts: Annotated[
...
class RemoveShareRequestTypedDict(TypedDict):
    user_id: int
...
class RemoveShareResponseTypedDict(TypedDict):
    content_type: str
