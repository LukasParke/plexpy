...
class ReloadGuideGlobalsTypedDict(TypedDict):
...
class ReloadGuideGlobals(BaseModel):
    accepts: Annotated[
...
class ReloadGuideRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class ReloadGuideRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class ReloadGuideResponseTypedDict(TypedDict):
    content_type: str
