...
class WriteMessageGlobalsTypedDict(TypedDict):
...
class WriteMessageGlobals(BaseModel):
    accepts: Annotated[
...
class WriteMessageRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class WriteMessageResponseTypedDict(TypedDict):
    content_type: str
