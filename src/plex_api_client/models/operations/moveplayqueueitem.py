...
class MovePlayQueueItemGlobalsTypedDict(TypedDict):
...
class MovePlayQueueItemGlobals(BaseModel):
    accepts: Annotated[
...
class MovePlayQueueItemRequestTypedDict(TypedDict):
    play_queue_id: int
    r"""The ID of the play queue."""
    play_queue_item_id: int
    r"""The play queue item ID to delete."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""The play queue item ID to insert the new item after. If not present, moves to the beginning."""


class MovePlayQueueItemRequest(BaseModel):
...
class MovePlayQueueItemResponseTypedDict(TypedDict):
    content_type: str
    ...
    r"""Successfully updated move an item in a play queue"""


class MovePlayQueueItemResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
