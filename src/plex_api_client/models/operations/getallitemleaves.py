...
class GetAllItemLeavesGlobalsTypedDict(TypedDict):
...
class GetAllItemLeavesGlobals(BaseModel):
    accepts: Annotated[
...
class GetAllItemLeavesRequestTypedDict(TypedDict):
    ids: str
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
...
class GetAllItemLeavesRequest(BaseModel):
    ids: Annotated[
...
class GetAllItemLeavesResponseTypedDict(TypedDict):
    content_type: str
...
class GetAllItemLeavesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
