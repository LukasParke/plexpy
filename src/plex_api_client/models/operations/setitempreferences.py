...
class SetItemPreferencesGlobalsTypedDict(TypedDict):
...
class SetItemPreferencesGlobals(BaseModel):
    accepts: Annotated[
...
class SetItemPreferencesResponseTypedDict(TypedDict):
    content_type: str
...
class SetItemPreferencesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
