...
class PlayerSubtitleStreamGlobalsTypedDict(TypedDict):
...
class PlayerSubtitleStreamGlobals(BaseModel):
    accepts: Annotated[
...
class PlayerSubtitleStreamRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""The unique identifier of the stream"""


class PlayerSubtitleStreamRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class PlayerSubtitleStreamResponseTypedDict(TypedDict):
    content_type: str
...
class PlayerSubtitleStreamResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
