...
import httpx
from plex_api_client.models.components import epgcountry as components_epgcountry
...
class GetCountriesMediaContainerTypedDict(TypedDict):
    ...
    country: NotRequired[List[components_epgcountry.EPGCountryTypedDict]]
...
class GetCountriesMediaContainer(BaseModel):
    ...
    country: Annotated[
        Optional[List[components_epgcountry.EPGCountry]],
        pydantic.Field(alias="Country"),
    ] = None
...
try:
    GetCountriesMediaContainer.model_rebuild()
except NameError:
    pass
try:
    GetCountriesResponseBody.model_rebuild()
except NameError:
    pass
