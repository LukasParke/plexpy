...
from plex_api_client.models.components import (
    ...
    cloudserverresponse as components_cloudserverresponse,
)
...
class GetCloudServerGlobalsTypedDict(TypedDict):
...
class GetCloudServerGlobals(BaseModel):
    accepts: Annotated[
...
class GetCloudServerRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetCloudServerRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetCloudServerResponseTypedDict(TypedDict):
    content_type: str
    ...
    cloud_server_response: NotRequired[
        components_cloudserverresponse.CloudServerResponseTypedDict
    ]
    r"""OK"""


class GetCloudServerResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    cloud_server_response: Optional[
        components_cloudserverresponse.CloudServerResponse
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["CloudServerResponse"])
        serialized = handler(self)
        m = {}
