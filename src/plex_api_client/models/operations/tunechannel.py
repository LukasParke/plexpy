...
class TuneChannelGlobalsTypedDict(TypedDict):
...
class TuneChannelGlobals(BaseModel):
    accepts: Annotated[
...
class TuneChannelRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    channel: str
    r"""The channel ID to tune"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class TuneChannelRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class TuneChannelResponseTypedDict(TypedDict):
    content_type: str
...
class TuneChannelResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
