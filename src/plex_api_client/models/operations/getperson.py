...
from plex_api_client.models.components import (
    ...
    mediacontainerwithtags as components_mediacontainerwithtags,
)
...
class GetPersonResponseTypedDict(TypedDict):
    ...
    media_container_with_tags: NotRequired[
        components_mediacontainerwithtags.MediaContainerWithTagsTypedDict
    ]
    r"""OK"""
...
class GetPersonResponse(BaseModel):
    ...
    media_container_with_tags: Optional[
        components_mediacontainerwithtags.MediaContainerWithTags
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["MediaContainerWithTags"])
        serialized = handler(self)
        m = {}
