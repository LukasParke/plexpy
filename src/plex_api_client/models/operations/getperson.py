...
class GetPersonGlobalsTypedDict(TypedDict):
...
class GetPersonGlobals(BaseModel):
    accepts: Annotated[
...
class GetPersonRequestTypedDict(TypedDict):
    person_id: str
    r"""Either the PMS tag `id` of the person or `tagKey` of the actor.  Note the `tagKey` is the hex portion of the plex guid for the actor"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetPersonMediaContainerTypedDict(TypedDict):
    ...
    """
    directory: NotRequired[List[components_tag.TagTypedDict]]


class GetPersonMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
    ...
    directory: Annotated[
        Optional[List[components_tag.Tag]], pydantic.Field(alias="Directory")
    ] = None
...
class GetPersonResponseBodyTypedDict(TypedDict):
    ...
    media_container: NotRequired[GetPersonMediaContainerTypedDict]
...
class GetPersonResponseBody(BaseModel):
    ...
    media_container: Annotated[
        Optional[GetPersonMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None
...
class GetPersonResponseTypedDict(TypedDict):
    ...
    object: NotRequired[GetPersonResponseBodyTypedDict]
    r"""OK"""
...
class GetPersonResponse(BaseModel):
    ...
    object: Optional[GetPersonResponseBody] = None
    r"""OK"""
...
try:
    GetPersonMediaContainer.model_rebuild()
except NameError:
    pass
try:
    GetPersonResponseBody.model_rebuild()
except NameError:
    pass
