...
class BrowseFilesystemGlobalsTypedDict(TypedDict):
...
class BrowseFilesystemGlobals(BaseModel):
    accepts: Annotated[
...
class BrowseFilesystemRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    include_files: NotRequired[components_boolint.BoolInt]
    r"""Include files in browse results"""


class BrowseFilesystemRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
    ...
    include_files: Annotated[
        ...
        pydantic.Field(alias="includeFiles"),
...
class BrowseFilesystemResponseTypedDict(TypedDict):
    content_type: str
