...
class GetSonicPathGlobalsTypedDict(TypedDict):
...
class GetSonicPathGlobals(BaseModel):
    accepts: Annotated[
...
class GetSonicPathRequestTypedDict(TypedDict):
    ...
    start_id: int
    r"""The starting metadata item id"""
    end_id: int
    r"""The ending metadata item id"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""The maximum distance allowed along the path; defaults to 0.25"""


class GetSonicPathRequest(BaseModel):
...
class GetSonicPathResponseTypedDict(TypedDict):
    content_type: str
...
class GetSonicPathResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
