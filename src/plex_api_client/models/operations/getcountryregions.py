...
class GetCountryRegionsGlobalsTypedDict(TypedDict):
...
class GetCountryRegionsGlobals(BaseModel):
    accepts: Annotated[
...
class GetCountryRegionsRequestTypedDict(TypedDict):
    country: str
    r"""3 letter country code"""
    epg_id: str
    r"""The `providerIdentifier` of the provider"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetCountryRegionsRequest(BaseModel):
    country: Annotated[
...
class GetCountryRegionsMediaContainer(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["identifier", "offset", "size", "totalSize", "Country"])
        serialized = handler(self)
        m = {}
...
class GetCountryRegionsResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[GetCountryRegionsMediaContainerTypedDict]


class GetCountryRegionsResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[GetCountryRegionsMediaContainer],
...
class GetCountryRegionsResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[GetCountryRegionsResponseBodyTypedDict]
    r"""OK"""


class GetCountryRegionsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    object: Optional[GetCountryRegionsResponseBody] = None
    r"""OK"""
...
try:
    GetCountryRegionsMediaContainer.model_rebuild()
except NameError:
    pass
try:
    GetCountryRegionsResponseBody.model_rebuild()
except NameError:
    pass
