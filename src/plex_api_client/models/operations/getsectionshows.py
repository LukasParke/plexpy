...
class GetSectionShowsGlobalsTypedDict(TypedDict):
...
class GetSectionShowsGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionShowsRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionShowsRequest(BaseModel):
...
class GetSectionShowsResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionShowsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
