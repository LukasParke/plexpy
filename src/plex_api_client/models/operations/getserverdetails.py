...
from plex_api_client.models.components import (
    ...
    serverconfiguration as components_serverconfiguration,
)
...
class GetServerDetailsGlobalsTypedDict(TypedDict):
...
class GetServerDetailsGlobals(BaseModel):
    accepts: Annotated[
...
class GetServerDetailsRequestTypedDict(TypedDict):
    machine_id: str
    r"""The unique machine identifier of the server"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetServerDetailsRequest(BaseModel):
    machine_id: Annotated[
        str,
        pydantic.Field(alias="machineId"),
...
class GetServerDetailsResponseTypedDict(TypedDict):
    content_type: str
    ...
    server_configuration: NotRequired[
        components_serverconfiguration.ServerConfigurationTypedDict
    ]
    r"""OK"""


class GetServerDetailsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    server_configuration: Optional[
        components_serverconfiguration.ServerConfiguration
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["ServerConfiguration"])
        serialized = handler(self)
        m = {}
