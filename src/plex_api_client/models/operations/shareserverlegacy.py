...
class ShareServerLegacyGlobalsTypedDict(TypedDict):
...
class ShareServerLegacyGlobals(BaseModel):
    accepts: Annotated[
...
class ShareServerLegacyRequestTypedDict(TypedDict):
    machine_id: str
...
class ShareServerLegacyRequest(BaseModel):
...
class ShareServerLegacyResponseTypedDict(TypedDict):
    content_type: str
...
class ShareServerLegacyResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
