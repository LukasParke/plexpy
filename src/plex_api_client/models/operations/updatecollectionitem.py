...
class UpdateCollectionItemGlobalsTypedDict(TypedDict):
...
class UpdateCollectionItemGlobals(BaseModel):
    accepts: Annotated[
...
class UpdateCollectionItemRequestTypedDict(TypedDict):
    collection_id: int
    r"""The collection id"""
    item_id: int
    r"""The item to delete"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class UpdateCollectionItemResponseTypedDict(TypedDict):
    content_type: str
...
class UpdateCollectionItemResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
