...
class DetectAdsGlobalsTypedDict(TypedDict):
...
class DetectAdsGlobals(BaseModel):
    accepts: Annotated[
...
class DetectAdsRequestTypedDict(TypedDict):
    ids: str
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
...
class DetectAdsResponseTypedDict(TypedDict):
    content_type: str
...
class DetectAdsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
