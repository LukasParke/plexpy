...
class UnmatchSectionItemsGlobalsTypedDict(TypedDict):
...
class UnmatchSectionItemsGlobals(BaseModel):
    accepts: Annotated[
...
class UnmatchSectionItemsRequestTypedDict(TypedDict):
    section_id: int
...
class UnmatchSectionItemsRequest(BaseModel):
...
class UnmatchSectionItemsResponseTypedDict(TypedDict):
    content_type: str
...
class UnmatchSectionItemsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
