...
class SetDVRPreferencesGlobalsTypedDict(TypedDict):
...
class SetDVRPreferencesGlobals(BaseModel):
    accepts: Annotated[
...
class SetDVRPreferencesRequestTypedDict(TypedDict):
    dvr_id: int
    r"""The ID of the DVR."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class SetDVRPreferencesResponseTypedDict(TypedDict):
    content_type: str
...
class SetDVRPreferencesResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
