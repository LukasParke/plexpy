...
class GetAvailableGrabbersGlobalsTypedDict(TypedDict):
...
class GetAvailableGrabbersGlobals(BaseModel):
    accepts: Annotated[
...
class GetAvailableGrabbersRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""Only return grabbers providing this protocol."""


class GetAvailableGrabbersRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class MediaGrabberTypedDict(TypedDict):
    identifier: NotRequired[str]
    protocol: NotRequired[str]
    title: NotRequired[str]


class MediaGrabber(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["identifier", "protocol", "title"])
        serialized = handler(self)
        m = {}
...
class GetAvailableGrabbersMediaContainerTypedDict(TypedDict):
    ...
    """
    media_grabber: NotRequired[List[MediaGrabberTypedDict]]


class GetAvailableGrabbersMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
    ...
    media_grabber: Annotated[
        Optional[List[MediaGrabber]], pydantic.Field(alias="MediaGrabber")
    ] = None

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(
            ["identifier", "offset", "size", "totalSize", "MediaGrabber"]
        )
        serialized = handler(self)
        m = {}
...
class GetAvailableGrabbersResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[GetAvailableGrabbersMediaContainerTypedDict]


class GetAvailableGrabbersResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[GetAvailableGrabbersMediaContainer],
...
class GetAvailableGrabbersResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[GetAvailableGrabbersResponseBodyTypedDict]
    r"""OK"""


class GetAvailableGrabbersResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    object: Optional[GetAvailableGrabbersResponseBody] = None
    r"""OK"""
...
try:
    GetAvailableGrabbersMediaContainer.model_rebuild()
except NameError:
    pass
try:
    GetAvailableGrabbersResponseBody.model_rebuild()
except NameError:
    pass
