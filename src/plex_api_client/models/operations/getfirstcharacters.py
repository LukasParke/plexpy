...
class GetFirstCharactersGlobalsTypedDict(TypedDict):
...
class GetFirstCharactersRequestTypedDict(TypedDict):
    section_id: int
...
class GetFirstCharactersMediaContainerTypedDict(TypedDict):
...
class GetFirstCharactersMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
...
class GetFirstCharactersResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[GetFirstCharactersMediaContainerTypedDict]


class GetFirstCharactersResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[GetFirstCharactersMediaContainer],
...
class GetFirstCharactersResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[GetFirstCharactersResponseBodyTypedDict]
    r"""OK"""


class GetFirstCharactersResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    object: Optional[GetFirstCharactersResponseBody] = None
    r"""OK"""
...
try:
    GetFirstCharactersMediaContainer.model_rebuild()
except NameError:
    pass
try:
    GetFirstCharactersResponseBody.model_rebuild()
except NameError:
    pass
