...
from plex_api_client.models.components import (
    ...
    webhookpayload as components_webhookpayload,
)
...
class GetWebhooksGlobalsTypedDict(TypedDict):
...
class GetWebhooksGlobals(BaseModel):
    accepts: Annotated[
...
class GetWebhooksRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetWebhooksResponseTypedDict(TypedDict):
    ...
    webhook_payload: NotRequired[components_webhookpayload.WebhookPayloadTypedDict]
    r"""OK"""
...
class GetWebhooksResponse(BaseModel):
    ...
    webhook_payload: Optional[components_webhookpayload.WebhookPayload] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["WebhookPayload"])
        serialized = handler(self)
        m = {}
