...
class GetSectionTagsGlobalsTypedDict(TypedDict):
...
class GetSectionTagsGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionTagsRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionTagsRequest(BaseModel):
...
class GetSectionTagsResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionTagsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
