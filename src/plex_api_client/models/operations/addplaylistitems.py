...
class AddPlaylistItemsGlobalsTypedDict(TypedDict):
...
class AddPlaylistItemsGlobals(BaseModel):
    accepts: Annotated[
...
class AddPlaylistItemsRequestTypedDict(TypedDict):
    playlist_id: int
...
class AddPlaylistItemsResponseTypedDict(TypedDict):
    content_type: str
    ...
    r"""Successfully updated adding to  a playlist"""


class AddPlaylistItemsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
