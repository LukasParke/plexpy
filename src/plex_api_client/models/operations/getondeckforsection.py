...
class GetOnDeckForSectionGlobalsTypedDict(TypedDict):
...
class GetOnDeckForSectionGlobals(BaseModel):
    accepts: Annotated[
...
class GetOnDeckForSectionRequestTypedDict(TypedDict):
    section_id: int
...
class GetOnDeckForSectionRequest(BaseModel):
...
class GetOnDeckForSectionResponseTypedDict(TypedDict):
    content_type: str
...
class GetOnDeckForSectionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
