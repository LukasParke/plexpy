...
from plex_api_client.models.components import (
    ...
    useroptoutsresponse as components_useroptoutsresponse,
)
...
class GetUserOptOutsGlobalsTypedDict(TypedDict):
...
class GetUserOptOutsGlobals(BaseModel):
    accepts: Annotated[
...
class GetUserOptOutsRequestTypedDict(TypedDict):
    uuid: str
    r"""The universally unique identifier"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetUserOptOutsRequest(BaseModel):
    uuid: Annotated[
...
class GetUserOptOutsResponseTypedDict(TypedDict):
    content_type: str
    ...
    user_opt_outs_response: NotRequired[
        components_useroptoutsresponse.UserOptOutsResponseTypedDict
    ]
    r"""OK"""


class GetUserOptOutsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    user_opt_outs_response: Optional[
        components_useroptoutsresponse.UserOptOutsResponse
    ] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["UserOptOutsResponse"])
        serialized = handler(self)
        m = {}
