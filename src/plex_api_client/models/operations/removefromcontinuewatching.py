...
class RemoveFromContinueWatchingGlobalsTypedDict(TypedDict):
...
class RemoveFromContinueWatchingGlobals(BaseModel):
    accepts: Annotated[
...
class RemoveFromContinueWatchingRequestTypedDict(TypedDict):
    key: str
...
class RemoveFromContinueWatchingResponseTypedDict(TypedDict):
    content_type: str
...
class RemoveFromContinueWatchingResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
