...
class GetHomeRecentlyAddedGlobalsTypedDict(TypedDict):
...
class GetHomeRecentlyAddedGlobals(BaseModel):
    accepts: Annotated[
...
class GetHomeRecentlyAddedRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetHomeRecentlyAddedRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetHomeRecentlyAddedResponseTypedDict(TypedDict):
    content_type: str
    ...
    r"""Recently added hub items"""


class GetHomeRecentlyAddedResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
