...
class CancelActivityGlobalsTypedDict(TypedDict):
...
class CancelActivityGlobals(BaseModel):
    accepts: Annotated[
...
class CancelActivityRequestTypedDict(TypedDict):
    activity_id: str
...
class CancelActivityResponseTypedDict(TypedDict):
    content_type: str
...
class CancelActivityResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
