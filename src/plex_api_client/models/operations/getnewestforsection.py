...
class GetNewestForSectionGlobalsTypedDict(TypedDict):
...
class GetNewestForSectionGlobals(BaseModel):
    accepts: Annotated[
...
class GetNewestForSectionRequestTypedDict(TypedDict):
    section_id: int
...
class GetNewestForSectionRequest(BaseModel):
...
class GetNewestForSectionResponseTypedDict(TypedDict):
    content_type: str
...
class GetNewestForSectionResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
