...
class GetAugmentationStatusGlobalsTypedDict(TypedDict):
...
class GetAugmentationStatusGlobals(BaseModel):
    accepts: Annotated[
...
class GetAugmentationStatusRequestTypedDict(TypedDict):
    augmentation_id: str
    r"""The id of the augmentation"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    wait: NotRequired[components_boolint.BoolInt]
    r"""Wait for augmentation completion before returning"""


class GetAugmentationStatusRequest(BaseModel):
    augmentation_id: Annotated[
        str,
        pydantic.Field(alias="augmentationId"),
...
class GetAugmentationStatusResponseTypedDict(TypedDict):
    content_type: str
...
class GetAugmentationStatusResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
