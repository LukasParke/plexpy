...
class DeletePlaylistItemGlobalsTypedDict(TypedDict):
...
class DeletePlaylistItemGlobals(BaseModel):
    accepts: Annotated[
...
class DeletePlaylistItemRequestTypedDict(TypedDict):
    playlist_id: int
...
class DeletePlaylistItemRequest(BaseModel):
...
class DeletePlaylistItemResponseTypedDict(TypedDict):
    content_type: str
