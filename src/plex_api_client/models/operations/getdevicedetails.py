...
class GetDeviceDetailsGlobalsTypedDict(TypedDict):
...
class GetDeviceDetailsGlobals(BaseModel):
    accepts: Annotated[
...
class GetDeviceDetailsRequestTypedDict(TypedDict):
    device_id: int
...
class GetDeviceDetailsRequest(BaseModel):
    device_id: Annotated[
        int,
...
class GetDeviceDetailsResponseTypedDict(TypedDict):
    content_type: str
...
class GetDeviceDetailsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
