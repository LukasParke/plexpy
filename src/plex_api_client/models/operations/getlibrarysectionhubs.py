...
class GetLibrarySectionHubsGlobalsTypedDict(TypedDict):
...
class GetLibrarySectionHubsGlobals(BaseModel):
    accepts: Annotated[
...
class GetLibrarySectionHubsRequestTypedDict(TypedDict):
    section_id: int
...
class GetLibrarySectionHubsRequest(BaseModel):
...
class GetLibrarySectionHubsResponseTypedDict(TypedDict):
    content_type: str
...
class GetLibrarySectionHubsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
