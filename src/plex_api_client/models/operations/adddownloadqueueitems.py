...
class AddDownloadQueueItemsGlobalsTypedDict(TypedDict):
...
class AddDownloadQueueItemsGlobals(BaseModel):
    accepts: Annotated[
...
class AddDownloadQueueItemsRequestTypedDict(TypedDict):
    ...
    location: NotRequired[components_location.Location]
...
class AddDownloadQueueItemsRequest(BaseModel):
    queue_id: Annotated[
        int,
    ...
    location: Annotated[
        Optional[components_location.Location],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Network type of the client, can be used to help determine target bitrate."""
...
class AddDownloadQueueItemsResponseBodyTypedDict(TypedDict):
    ...
    media_container: NotRequired[AddDownloadQueueItemsMediaContainerTypedDict]


class AddDownloadQueueItemsResponseBody(BaseModel):
    r"""OK"""
...
class AddDownloadQueueItemsResponseTypedDict(TypedDict):
    ...
    object: NotRequired[AddDownloadQueueItemsResponseBodyTypedDict]
    r"""OK"""


class AddDownloadQueueItemsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
