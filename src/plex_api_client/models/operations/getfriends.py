...
class GetFriendsGlobalsTypedDict(TypedDict):
...
class GetFriendsGlobals(BaseModel):
    accepts: Annotated[
...
class GetFriendsRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class Users(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["title", "email", "id", "thumb", "username", "uuid"])
        serialized = handler(self)
        m = {}
...
class GetFriendsResponseBodyTypedDict(TypedDict):
    r"""List of friends"""

    users: NotRequired[List[UsersTypedDict]]


class GetFriendsResponseBody(BaseModel):
    r"""List of friends"""
...
class GetFriendsResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[GetFriendsResponseBodyTypedDict]
    r"""List of friends"""
...
class GetFriendsResponse(BaseModel):
    ...
    object: Optional[GetFriendsResponseBody] = None
    r"""List of friends"""
