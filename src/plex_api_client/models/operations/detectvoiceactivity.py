...
class DetectVoiceActivityGlobalsTypedDict(TypedDict):
...
class DetectVoiceActivityGlobals(BaseModel):
    accepts: Annotated[
...
class DetectVoiceActivityRequestTypedDict(TypedDict):
    ids: str
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
...
class DetectVoiceActivityRequest(BaseModel):
    ids: Annotated[
...
class DetectVoiceActivityResponseTypedDict(TypedDict):
    content_type: str
...
class DetectVoiceActivityResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
