...
class RemoveDownloadQueueItemsGlobalsTypedDict(TypedDict):
...
class RemoveDownloadQueueItemsGlobals(BaseModel):
    accepts: Annotated[
...
class RemoveDownloadQueueItemsRequestTypedDict(TypedDict):
    queue_id: int
    r"""The queue id"""
    item_id: List[int]
    r"""The item id"""
...
class RemoveDownloadQueueItemsRequest(BaseModel):
    queue_id: Annotated[
        int,
...
class RemoveDownloadQueueItemsResponseTypedDict(TypedDict):
    content_type: str
...
class RemoveDownloadQueueItemsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
