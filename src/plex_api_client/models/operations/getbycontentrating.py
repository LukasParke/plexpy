...
class GetByContentRatingGlobalsTypedDict(TypedDict):
...
class GetByContentRatingGlobals(BaseModel):
    accepts: Annotated[
...
class GetByContentRatingRequestTypedDict(TypedDict):
    section_id: int
...
class GetByContentRatingRequest(BaseModel):
...
class GetByContentRatingResponseTypedDict(TypedDict):
    content_type: str
...
class GetByContentRatingResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
