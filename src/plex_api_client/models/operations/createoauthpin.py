...
from plex_api_client.utils import FieldMetadata, HeaderMetadata, SecurityMetadata
import pydantic
...
class CreateOAuthPinGlobalsTypedDict(TypedDict):
...
class CreateOAuthPinGlobals(BaseModel):
    accepts: Annotated[
...
class CreateOAuthPinSecurityTypedDict(TypedDict):
    client_identifier: str


class CreateOAuthPinSecurity(BaseModel):
    client_identifier: Annotated[
        str,
        FieldMetadata(
...
class CreateOAuthPinRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class CreateOAuthPinRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class CreateOAuthPinResponseBodyTypedDict(TypedDict):
    r"""PIN created successfully"""
...
class CreateOAuthPinResponseBody(BaseModel):
    r"""PIN created successfully"""
...
class CreateOAuthPinResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[CreateOAuthPinResponseBodyTypedDict]
    r"""PIN created successfully"""


class CreateOAuthPinResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    object: Optional[CreateOAuthPinResponseBody] = None
    r"""PIN created successfully"""
...
try:
    CreateOAuthPinResponseBody.model_rebuild()
except NameError:
    pass
