...
class GetCollectionItemsGlobalsTypedDict(TypedDict):
...
class GetCollectionItemsGlobals(BaseModel):
    accepts: Annotated[
...
class GetCollectionItemsRequestTypedDict(TypedDict):
    collection_id: int
    r"""The collection id"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
...
class GetCollectionItemsRequest(BaseModel):
...
class GetCollectionItemsResponseTypedDict(TypedDict):
    content_type: str
...
class GetCollectionItemsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
