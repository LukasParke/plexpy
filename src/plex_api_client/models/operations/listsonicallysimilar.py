...
class ListSonicallySimilarGlobalsTypedDict(TypedDict):
...
class ListSonicallySimilarGlobals(BaseModel):
    accepts: Annotated[
...
class ListSonicallySimilarRequestTypedDict(TypedDict):
    ids: str
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
...
class ListSonicallySimilarRequest(BaseModel):
    ids: Annotated[
...
class ListSonicallySimilarResponseTypedDict(TypedDict):
    content_type: str
...
class ListSonicallySimilarResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
