...
class DeleteMediaProviderGlobalsTypedDict(TypedDict):
...
class DeleteMediaProviderGlobals(BaseModel):
    accepts: Annotated[
...
class DeleteMediaProviderRequestTypedDict(TypedDict):
    provider: str
    r"""The ID of the media provider to delete"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class DeleteMediaProviderRequest(BaseModel):
    provider: Annotated[
...
class DeleteMediaProviderResponseTypedDict(TypedDict):
    content_type: str
...
class DeleteMediaProviderResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
