...
class GetCommonGlobalsTypedDict(TypedDict):
...
class GetCommonGlobals(BaseModel):
    accepts: Annotated[
...
class GetCommonRequestTypedDict(TypedDict):
    section_id: int
...
class GetCommonResponseTypedDict(TypedDict):
    content_type: str
...
class GetCommonResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
