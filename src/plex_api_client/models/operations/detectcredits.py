...
class DetectCreditsGlobalsTypedDict(TypedDict):
...
class DetectCreditsGlobals(BaseModel):
    accepts: Annotated[
...
class DetectCreditsRequest(BaseModel):
    ids: Annotated[
...
class DetectCreditsResponseTypedDict(TypedDict):
    content_type: str
...
class DetectCreditsResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
