...
class GetStreamGlobalsTypedDict(TypedDict):
...
class GetStreamGlobals(BaseModel):
    accepts: Annotated[
...
class GetStreamRequestTypedDict(TypedDict):
    ...
    ext: str
    r"""The extension of the stream.  Required to fetch the `sub` portion of `idx`/`sub` subtitles"""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""The requested encoding for the subtitle (only used for text subtitles)"""
    format_: NotRequired[str]
    r"""The requested format for the subtitle to convert the subtitles to (only used for text subtitles)"""
