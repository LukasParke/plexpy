...
class RemoveDeviceGlobalsTypedDict(TypedDict):
...
class RemoveDeviceGlobals(BaseModel):
    accepts: Annotated[
...
class RemoveDeviceRequestTypedDict(TypedDict):
    device_id: int
...
class RemoveDeviceMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
...
class RemoveDeviceResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[RemoveDeviceMediaContainerTypedDict]


class RemoveDeviceResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[RemoveDeviceMediaContainer], pydantic.Field(alias="MediaContainer")
    ] = None
...
class RemoveDeviceResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[RemoveDeviceResponseBodyTypedDict]
    r"""OK"""
...
class RemoveDeviceResponse(BaseModel):
    ...
    object: Optional[RemoveDeviceResponseBody] = None
    r"""OK"""
...
try:
    RemoveDeviceMediaContainer.model_rebuild()
except NameError:
    pass
try:
    RemoveDeviceResponseBody.model_rebuild()
except NameError:
    pass
