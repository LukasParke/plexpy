...
class SplitItemGlobalsTypedDict(TypedDict):
...
class SplitItemGlobals(BaseModel):
    accepts: Annotated[
...
class SplitItemRequestTypedDict(TypedDict):
    ids: str
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
...
class SplitItemResponseTypedDict(TypedDict):
    content_type: str
