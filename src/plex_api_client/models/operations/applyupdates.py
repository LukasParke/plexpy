...
class ApplyUpdatesGlobalsTypedDict(TypedDict):
...
class ApplyUpdatesGlobals(BaseModel):
    accepts: Annotated[
...
class ApplyUpdatesRequestTypedDict(TypedDict):
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    tonight: NotRequired[components_boolint.BoolInt]
    ...
    skip: NotRequired[components_boolint.BoolInt]
