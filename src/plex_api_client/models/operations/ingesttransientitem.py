...
class IngestTransientItemGlobalsTypedDict(TypedDict):
...
class IngestTransientItemGlobals(BaseModel):
    accepts: Annotated[
...
class IngestTransientItemRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    r"""The marketplace on which the client application is distributed"""
    url: NotRequired[str]
    r"""The file of the file to ingest."""
    virtual_file_path: NotRequired[str]
    r"""A virtual path to use when the url is opaque."""
    compute_hashes: NotRequired[components_boolint.BoolInt]
    r"""Whether or not to compute Plex and OpenSubtitle hashes for the file. Defaults to 0."""
    ingest_non_matches: NotRequired[components_boolint.BoolInt]
    r"""Whether or not non matching media should be stored. Defaults to 0."""


class IngestTransientItemRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
    ...
    virtual_file_path: Annotated[
        Optional[str],
        pydantic.Field(alias="virtualFilePath"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""A virtual path to use when the url is opaque."""

    compute_hashes: Annotated[
...
class IngestTransientItemResponseTypedDict(TypedDict):
    content_type: str
...
class IngestTransientItemResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
