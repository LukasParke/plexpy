...
from plex_api_client.models.components import (
    ...
    authkeysresponse as components_authkeysresponse,
)
...
class GetAuthKeysGlobalsTypedDict(TypedDict):
...
class GetAuthKeysGlobals(BaseModel):
    accepts: Annotated[
...
class GetAuthKeysRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetAuthKeysRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
...
class GetAuthKeysResponseTypedDict(TypedDict):
    content_type: str
    ...
    auth_keys_response: NotRequired[
        components_authkeysresponse.AuthKeysResponseTypedDict
    ]
    r"""OK"""


class GetAuthKeysResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    auth_keys_response: Optional[components_authkeysresponse.AuthKeysResponse] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["AuthKeysResponse"])
        serialized = handler(self)
        m = {}
