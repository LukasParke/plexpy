...
class GetSessionPlaylistIndexGlobalsTypedDict(TypedDict):
...
class GetSessionPlaylistIndexGlobals(BaseModel):
    accepts: Annotated[
...
class GetSessionPlaylistIndexRequestTypedDict(TypedDict):
    session_id: str
    r"""The session id"""
    consumer_id: str
    r"""The consumer id"""
...
class GetSessionPlaylistIndexRequest(BaseModel):
...
class GetSessionPlaylistIndexResponseTypedDict(TypedDict):
    content_type: str
    ...
    r"""Index playlist for playing HLS content"""


class GetSessionPlaylistIndexResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
