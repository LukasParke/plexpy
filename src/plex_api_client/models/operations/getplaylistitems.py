...
class GetPlaylistItemsGlobalsTypedDict(TypedDict):
...
class GetPlaylistItemsGlobals(BaseModel):
    accepts: Annotated[
...
class GetPlaylistItemsRequestTypedDict(TypedDict):
    playlist_id: int
...
class GetPlaylistItemsRequest(BaseModel):
...
class GetPlaylistItemsResponseTypedDict(TypedDict):
    content_type: str
