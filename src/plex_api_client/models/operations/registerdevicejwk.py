...
from plex_api_client.models.components import (
    ...
    authtokenresponse as components_authtokenresponse,
    jwkregistrationrequest as components_jwkregistrationrequest,
)
...
class RegisterDeviceJWKGlobalsTypedDict(TypedDict):
...
class RegisterDeviceJWKGlobals(BaseModel):
    accepts: Annotated[
...
class RegisterDeviceJWKRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
    ...
    marketplace: NotRequired[str]
    r"""The marketplace on which the client application is distributed"""
    jwk_registration_request: NotRequired[
        components_jwkregistrationrequest.JWKRegistrationRequestTypedDict
    ]


class RegisterDeviceJWKRequest(BaseModel):
    accepts: Annotated[
        Optional[components_accepts.Accepts],
        FieldMetadata(header=HeaderMetadata(style="simple", explode=False)),
    ] = components_accepts.Accepts.APPLICATION_XML
    ...
    jwk_registration_request: Annotated[
        Optional[components_jwkregistrationrequest.JWKRegistrationRequest],
...
class RegisterDeviceJWKResponseTypedDict(TypedDict):
    content_type: str
    ...
    auth_token_response: NotRequired[
        components_authtokenresponse.AuthTokenResponseTypedDict
    ]
    r"""OK"""


class RegisterDeviceJWKResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    auth_token_response: Optional[components_authtokenresponse.AuthTokenResponse] = None
    r"""OK"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["AuthTokenResponse"])
        serialized = handler(self)
        m = {}
