...
class GetSectionTimelineGlobalsTypedDict(TypedDict):
...
class GetSectionTimelineGlobals(BaseModel):
    accepts: Annotated[
...
class GetSectionTimelineRequestTypedDict(TypedDict):
    section_id: int
...
class GetSectionTimelineRequest(BaseModel):
...
class GetSectionTimelineResponseTypedDict(TypedDict):
    content_type: str
...
class GetSectionTimelineResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
