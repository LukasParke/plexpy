...
class GetPreferenceGlobalsTypedDict(TypedDict):
...
class GetPreferenceGlobals(BaseModel):
    accepts: Annotated[
...
class GetPreferenceRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class GetPreferenceResponseTypedDict(TypedDict):
    content_type: str
