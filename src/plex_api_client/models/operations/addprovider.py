...
class AddProviderGlobalsTypedDict(TypedDict):
...
class AddProviderGlobals(BaseModel):
    accepts: Annotated[
...
class AddProviderRequestTypedDict(TypedDict):
    url: str
    r"""The URL of the media provider to add."""
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class AddProviderResponseTypedDict(TypedDict):
    content_type: str
