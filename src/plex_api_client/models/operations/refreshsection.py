...
class RefreshSectionGlobalsTypedDict(TypedDict):
...
class RefreshSectionGlobals(BaseModel):
    accepts: Annotated[
...
class RefreshSectionRequestTypedDict(TypedDict):
    section_id: int
...
class RefreshSectionResponseTypedDict(TypedDict):
    content_type: str
