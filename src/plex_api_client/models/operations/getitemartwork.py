...
class GetItemArtworkGlobalsTypedDict(TypedDict):
...
class GetItemArtworkGlobals(BaseModel):
    accepts: Annotated[
...
class GetItemArtworkRequest(BaseModel):
    ids: Annotated[
...
class GetItemArtworkResponseTypedDict(TypedDict):
    content_type: str
    ...
    two_hundred_audio_mpeg3_response_stream: NotRequired[httpx.Response]
    r"""OK"""
    two_hundred_image_jpeg_response_stream: NotRequired[httpx.Response]
    r"""OK"""


class GetItemArtworkResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    two_hundred_audio_mpeg3_response_stream: Optional[httpx.Response] = None
    r"""OK"""
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["200_audio/mpeg3_response-stream", "200_image/jpeg_response-stream"]
        )
        serialized = handler(self)
        m = {}
