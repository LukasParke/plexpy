...
class AddDeviceGlobalsTypedDict(TypedDict):
...
class AddDeviceGlobals(BaseModel):
    accepts: Annotated[
...
class AddDeviceRequestTypedDict(TypedDict):
    accepts: NotRequired[components_accepts.Accepts]
    r"""Indicates the client accepts the indicated media types"""
    client_identifier: NotRequired[str]
    r"""An opaque identifier unique to the client"""
...
class AddDeviceResponseTypedDict(TypedDict):
    content_type: str
