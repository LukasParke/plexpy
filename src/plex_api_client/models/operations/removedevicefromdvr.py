...
class RemoveDeviceFromDVRGlobalsTypedDict(TypedDict):
...
class RemoveDeviceFromDVRGlobals(BaseModel):
    accepts: Annotated[
...
class RemoveDeviceFromDVRRequest(BaseModel):
    dvr_id: Annotated[
        int,
...
class RemoveDeviceFromDVRDVRsMediaContainerTypedDict(TypedDict):
...
class RemoveDeviceFromDVRDVRsMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
...
class RemoveDeviceFromDVRMediaContainer(BaseModel):
    media_container: Annotated[
        Optional[RemoveDeviceFromDVRDVRsMediaContainer],
...
class RemoveDeviceFromDVRResponseBodyTypedDict(TypedDict):
    r"""OK"""

    media_container: NotRequired[RemoveDeviceFromDVRMediaContainerTypedDict]


class RemoveDeviceFromDVRResponseBody(BaseModel):
    r"""OK"""

    media_container: Annotated[
        Optional[RemoveDeviceFromDVRMediaContainer],
        pydantic.Field(alias="MediaContainer"),
    ] = None
...
class RemoveDeviceFromDVRResponseTypedDict(TypedDict):
    content_type: str
    ...
    object: NotRequired[RemoveDeviceFromDVRResponseBodyTypedDict]
    r"""OK"""


class RemoveDeviceFromDVRResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
    ...
    object: Optional[RemoveDeviceFromDVRResponseBody] = None
    r"""OK"""
...
try:
    ...
    pass
try:
    RemoveDeviceFromDVRMediaContainer.model_rebuild()
except NameError:
    pass
try:
    RemoveDeviceFromDVRResponseBody.model_rebuild()
except NameError:
    pass
