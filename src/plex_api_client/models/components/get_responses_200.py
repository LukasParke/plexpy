...
from .managedhub import ManagedHub, ManagedHubTypedDict
...
class GetResponses200MediaContainerTypedDict(TypedDict):
    ...
    hub: NotRequired[List[ManagedHubTypedDict]]
...
class GetResponses200MediaContainer(BaseModel):
    ...
    hub: Annotated[Optional[List[ManagedHub]], pydantic.Field(alias="Hub")] = None
