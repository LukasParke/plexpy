...
class MediaContainerWithPlaylistMetadataGuidsTypedDict(TypedDict):
    id: str
    r"""The unique identifier for the Guid. Can be prefixed with imdb://, tmdb://, tvdb://"""


class MediaContainerWithPlaylistMetadataGuids(BaseModel):
    id: str
    r"""The unique identifier for the Guid. Can be prefixed with imdb://, tmdb://, tvdb://"""


class MediaContainerWithPlaylistMetadataSkipChildren2(str, Enum):
    ZERO = "0"
    ONE = "1"


class MediaContainerWithPlaylistMetadataSkipParent2(str, Enum):
    ZERO = "0"
    ONE = "1"


MediaContainerWithPlaylistMetadataSkipChildrenTypedDict = TypeAliasType(
    "MediaContainerWithPlaylistMetadataSkipChildrenTypedDict",
    Union[bool, MediaContainerWithPlaylistMetadataSkipChildren2],
)
...
MediaContainerWithPlaylistMetadataSkipChildren = TypeAliasType(
...
MediaContainerWithPlaylistMetadataSkipParentTypedDict = TypeAliasType(
    "MediaContainerWithPlaylistMetadataSkipParentTypedDict",
    Union[bool, MediaContainerWithPlaylistMetadataSkipParent2],
)
r"""When present on an episode or track item, indicates parent should be skipped in favor of grandparent (show)."""


MediaContainerWithPlaylistMetadataSkipParent = TypeAliasType(
...
class MediaContainerWithPlaylistMetadataMetadataTypedDict(TypedDict):
    ...
    r"""If we return this as true then this playlist cannot be altered or deleted directly by the client."""
    ...
    r"""Total duration in seconds (redundant but present in XML)."""
    ...
    r"""The type of the playlist."""
    radio: NotRequired[bool]
    r"""Whether this is a generated radio playlist."""
    smart: NotRequired[bool]
    r"""Whether or not the playlist is smart."""
    special_playlist_type: NotRequired[str]
    r"""If this is a special playlist, this returns its type (e.g. favorites)."""
    ...
    guids: NotRequired[List[MediaContainerWithPlaylistMetadataGuidsTypedDict]]
    ...
    skip_children: NotRequired[MediaContainerWithPlaylistMetadataSkipChildrenTypedDict]
    r"""When found on a show item, indicates that the children (seasons) should be skipped in favor of the grandchildren (episodes). Useful for mini-series, etc."""
    skip_count: NotRequired[int]
    r"""Number of times this track has been skipped."""
    skip_parent: NotRequired[MediaContainerWithPlaylistMetadataSkipParentTypedDict]
    r"""When present on an episode or track item, indicates parent should be skipped in favor of grandparent (show)."""
...
class MediaContainerWithPlaylistMetadataMetadata(BaseModel):
    r"""Items in a library are referred to as \"metadata items.\" These metadata items are distinct from \"media items\" which represent actual instances of media that can be consumed. Consider a TV library that has a single video file in it for a particular episode of a show. The library has a single media item, but it has three metadata items: one for the show, one for the season, and one for the episode. Consider a movie library that has two video files in it: the same movie, but two different resolutions. The library has a single metadata item for the movie, but that metadata item has two media items, one for each resolution. Additionally a \"media item\" will have one or more \"media parts\" where the the parts are intended to be watched together, such as a CD1 and CD2 parts of the same movie.
    ...
    duration_in_seconds: Annotated[
        Optional[int], pydantic.Field(alias="durationInSeconds")
    ] = None
    r"""Total duration in seconds (redundant but present in XML)."""
    ...
    playlist_type: Annotated[
        Optional[PlaylistType], pydantic.Field(alias="playlistType")
    ] = None
    r"""The type of the playlist."""
    ...
    special_playlist_type: Annotated[
        Optional[str], pydantic.Field(alias="specialPlaylistType")
    ] = None
    r"""If this is a special playlist, this returns its type (e.g. favorites)."""
    ...
    guids: Annotated[
        Optional[List[MediaContainerWithPlaylistMetadataGuids]],
    ...
    skip_children: Annotated[
        Optional[MediaContainerWithPlaylistMetadataSkipChildren],
    ...
    skip_parent: Annotated[
        Optional[MediaContainerWithPlaylistMetadataSkipParent],
...
class MediaContainerWithPlaylistMetadataMediaContainerTypedDict(TypedDict):
    ...
    metadata: NotRequired[List[MediaContainerWithPlaylistMetadataMetadataTypedDict]]


class MediaContainerWithPlaylistMetadataMediaContainer(BaseModel):
    r"""`MediaContainer` is the root element of most Plex API responses. It serves as a generic container for various types of content (Metadata, Hubs, Directories, etc.) and includes pagination information (offset, size, totalSize) when applicable.
    Common attributes: - identifier: Unique identifier for this container - size: Number of items in this response page - totalSize: Total number of items available (for pagination) - offset: Starting index of this page (for pagination)
    The container often \"hoists\" common attributes from its children. For example, if all tracks in a container share the same album title, the `parentTitle` attribute may appear on the MediaContainer rather than being repeated on each track.
    """
    ...
    metadata: Annotated[
        Optional[List[MediaContainerWithPlaylistMetadataMetadata]],
...
class MediaContainerWithPlaylistMetadata(BaseModel):
