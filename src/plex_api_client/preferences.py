...
class Preferences(BaseSDK):
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="getAllPreferences",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetAllPreferencesResponse(
    ...
    async def get_all_preferences_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def set_preferences(
        ...
        *,
        request: Union[
            operations.SetPreferencesRequest, operations.SetPreferencesRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.SetPreferencesRequest)
        request = cast(operations.SetPreferencesRequest, request)
        ...
        req = self._build_request(
            ...
            accept_header_value="*/*",
            http_headers=http_headers,
            _globals=operations.SetPreferencesGlobals(
        ...
        if utils.match_response(http_res, "200", "*"):
            return operations.SetPreferencesResponse(
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
            )
    ...
    async def set_preferences_async(
        self,
        *,
        request: Union[
            operations.SetPreferencesRequest, operations.SetPreferencesRequestTypedDict
    ...
    def get_preference(
        ...
        *,
        request: Union[
            operations.GetPreferenceRequest, operations.GetPreferenceRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetPreferenceRequest)
        request = cast(operations.GetPreferenceRequest, request)
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=operations.GetPreferenceGlobals(
                accepts=self.sdk_configuration.globals.accepts,
                client_identifier=self.sdk_configuration.globals.client_identifier,
                product=self.sdk_configuration.globals.product,
                version=self.sdk_configuration.globals.version,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetPreferenceResponse(
                media_container_with_settings=unmarshal_json_response(
                    Optional[components.MediaContainerWithSettings], http_res
                ),
                status_code=http_res.status_code,
