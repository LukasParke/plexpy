    ...
    def create_collection(
        ...
        *,
        request: Union[
            ...
            operations.CreateCollectionRequestTypedDict,
        ],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.CreateCollectionRequest)
        request = cast(operations.CreateCollectionRequest, request)
        ...
        req = self._build_request(
            ...
            _globals=operations.CreateCollectionGlobals(
