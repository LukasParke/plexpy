...
class Playlists(BaseSDK):
    r"""Plex Playlists operations"""

    def delete_playlist_by_rating_key(
        self,
        *,
        request: Union[
            operations.DeletePlaylistByRatingKeyRequest,
            operations.DeletePlaylistByRatingKeyRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.DeletePlaylistByRatingKeyResponse:
        r"""Delete Playlist
        ...
        request = cast(operations.DeletePlaylistByRatingKeyRequest, request)
        ...
        req = self._build_request(
            ...
            _globals=operations.DeletePlaylistByRatingKeyGlobals(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="deletePlaylistByRatingKey",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.DeletePlaylistByRatingKeyResponse(
    ...
    async def delete_playlist_by_rating_key_async(
        self,
        *,
        request: Union[
            operations.DeletePlaylistByRatingKeyRequest,
