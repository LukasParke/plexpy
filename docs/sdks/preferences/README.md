...
* [get_all_preferences](#get_all_preferences) - Get all preferences
* [set_preferences](#set_preferences) - Set preferences
* [get_preference](#get_preference) - Get a preferences
...
<!-- UsageSnippet language="python" operationID="getAllPreferences" method="get" path="/:/prefs" -->
```python
...
**[operations.GetAllPreferencesResponse](../../models/operations/getallpreferencesresponse.md)**
...
<!-- UsageSnippet language="python" operationID="setPreferences" method="put" path="/:/prefs" -->
```python
from plex_api_client import PlexAPI
...
**[operations.SetPreferencesResponse](../../models/operations/setpreferencesresponse.md)**
...
<!-- UsageSnippet language="python" operationID="getPreference" method="get" path="/:/prefs/get" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
**[operations.GetPreferenceResponse](../../models/operations/getpreferenceresponse.md)**
