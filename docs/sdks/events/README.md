...
<!-- UsageSnippet language="python" operationID="getNotifications" method="get" path="/:/eventsource/notifications" -->
```python
...
<!-- UsageSnippet language="python" operationID="connectWebSocket" method="get" path="/:/websocket/notifications" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
**[operations.ConnectWebSocketResponse](../../models/operations/connectwebsocketresponse.md)**
