...
* [get_collection_items](#get_collection_items) - Get items in a collection
* [get_metadata_item](#get_metadata_item) - Get a metadata item
* [get_albums](#get_albums) - Set section albums
* [list_content](#list_content) - Get items in the section
* [get_all_leaves](#get_all_leaves) - Set section leaves
* [get_arts](#get_arts) - Set section artwork
* [get_categories](#get_categories) - Set section categories
* [get_cluster](#get_cluster) - Set section clusters
* [get_sonic_path](#get_sonic_path) - Similar tracks to transition from one to another
* [get_folders](#get_folders) - Get all folder locations
* [list_moments](#list_moments) - Set section moments
* [get_sonically_similar](#get_sonically_similar) - The nearest audio tracks
* [get_collection_image](#get_collection_image) - Get a collection's image
...
<!-- UsageSnippet language="python" operationID="getCollectionItems" method="get" path="/library/collections/{collectionId}/items" -->
```python
...
**[operations.GetCollectionItemsResponse](../../models/operations/getcollectionitemsresponse.md)**
...
<!-- UsageSnippet language="python" operationID="getMetadataItem" method="get" path="/library/metadata/{ids}" -->
```python
from plex_api_client import PlexAPI
...
**[operations.GetMetadataItemResponse](../../models/operations/getmetadataitemresponse.md)**
...
<!-- UsageSnippet language="python" operationID="getAlbums" method="get" path="/library/sections/{sectionId}/albums" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
**[operations.GetAlbumsResponse](../../models/operations/getalbumsresponse.md)**
...
<!-- UsageSnippet language="python" operationID="getAllLeaves" method="get" path="/library/sections/{sectionId}/allLeaves" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
**[operations.GetAllLeavesResponse](../../models/operations/getallleavesresponse.md)**
...
<!-- UsageSnippet language="python" operationID="getArts" method="get" path="/library/sections/{sectionId}/arts" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
**[operations.GetArtsResponse](../../models/operations/getartsresponse.md)**
...
<!-- UsageSnippet language="python" operationID="getCategories" method="get" path="/library/sections/{sectionId}/categories" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
<!-- UsageSnippet language="python" operationID="getCluster" method="get" path="/library/sections/{sectionId}/cluster" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
**[operations.GetClusterResponse](../../models/operations/getclusterresponse.md)**
...
<!-- UsageSnippet language="python" operationID="getSonicPath" method="get" path="/library/sections/{sectionId}/computePath" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
**[operations.GetSonicPathResponse](../../models/operations/getsonicpathresponse.md)**
...
<!-- UsageSnippet language="python" operationID="getFolders" method="get" path="/library/sections/{sectionId}/location" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
<!-- UsageSnippet language="python" operationID="listMoments" method="get" path="/library/sections/{sectionId}/moment" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
**[operations.ListMomentsResponse](../../models/operations/listmomentsresponse.md)**
...
<!-- UsageSnippet language="python" operationID="getSonicallySimilar" method="get" path="/library/sections/{sectionId}/nearest" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
**[operations.GetSonicallySimilarResponse](../../models/operations/getsonicallysimilarresponse.md)**
...
<!-- UsageSnippet language="python" operationID="getCollectionImage" method="get" path="/library/collections/{collectionId}/composite/{updatedAt}" -->
```python
from plex_api_client import PlexAPI
from plex_api_client.models import components
...
**[operations.GetCollectionImageResponse](../../models/operations/getcollectionimageresponse.md)**
